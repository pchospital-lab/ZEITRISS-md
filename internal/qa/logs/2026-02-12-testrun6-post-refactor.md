...
- Risiken: Spieler könnten wichtige Gate-Erinnerungen verpassen bei längeren Sessions
...
- Maintainer: HUD-Budget-Logik in `systems/hud/` reviewen und Dedupe-Flag implementieren
...
- Maintainer: Squad-AI-Module auf Offline-Kompatibilität prüfen
...
- Maintainer: Economy-Balance zwischen Modi definieren, Merge-Policies festlegen
...
- Maintainer: Paradoxon-Flow-Timing in `systems/paradoxon/` stabilisieren
...
- Maintainer: Arena-Isolation in `systems/arena/` verstärken
...
- Maintainer: UI-Persistence-Strategie in `systems/ui/` überarbeiten
...
- Maintainer: NPC vs Human Balance-Matrix definieren
...
- Maintainer: Rift-Seed-Management-Flow in `systems/gameflow/` ausbauen
...
```json
{
  ...
  "logs": {
    "artifact_log": [{ "name": "Temporal_Resonator", "acquired": "EP1_MS2", "value": 2500 }],
    "market": [],
    "offline": [],
    "kodex": [
      {
        ...
        "type": "briefing",
        "content": "Mission 3 Objektive bestätigt"
      }
    ],
    "alias_trace": [],
    "squad_radio": [
    ...
    "foreshadow": [{ "mission": 5, "scene": 10, "type": "boss_encounter", "status": "pending" }],
    "fr_interventions": [],
    "psi": [],
    "arena_psi": [],
    "trace": [
      ...
      {
        "event": "hud_budget_overflow",
        "details": { "scene": 5, "suppressed": 1 },
    ...
    "hud": [
      {
        "event": "gate_status",
        "scene": 1,
        "details": { "gate": "1/2", "fs": "2/4" },
        "at": "2025-12-27T10:20:00Z"
      }
    ],
    "flags": {
      "qa_mode": true,

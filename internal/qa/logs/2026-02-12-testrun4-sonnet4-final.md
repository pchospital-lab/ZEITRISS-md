...
- Diagnose: Spieler erwarten eine intuitive Ansprache, nicht Parser-Syntax-Hinweise
...
- Maintainer: Neue Dispatcher-Strings in Runtime-Module integrieren
...
- Maintainer: HUD-Event-Allowlist erweitern und Prioritätslevel dokumentieren
...
- Maintainer: Economy-Schema erweitern, Merge-Conflict-Handling verbessern
...
- Risiken: Spieler könnten trotzdem Verwirrung über Verfügbarkeit haben
...
- Maintainer: Toast-Texte überarbeiten, Paradoxon-Timing klarer kommunizieren
- Notizen: Besonders relevant für neue Spieler
...
- Maintainer: Boss-DR-Dokumentation aktualisieren oder Code-Implementierung anpassen
...
- Maintainer: Save-Guard-Matrix dokumentieren, Offline-Handling standardisieren
- Notizen: Wichtig für Spieler mit instabiler Verbindung
...
- Maintainer: UI-Flags in Save-Schema ergänzen, Load-Restauration implementieren
...
- Risiken: Komplexe Merge-Logik könnte Spieler überfordern
...
- Maintainer: Merge-Algorithmus dokumentieren, eventuell vereinfachen
- Notizen: Besonders relevant für High-Level-Spieler mit vielen Seeds
...
```json
{
  ...
  "logs": {
    ...
    "kodex": [
      {
        "query": "Paradoxon-Index",
        "response": "Aktuell bei 3/5",
        "timestamp": "2025-01-15T10:30:00Z"
      }
    ],
    "alias_trace": [],
    "squad_radio": [
      { "speaker": "Agent_Kappa", "message": "Infiltration bestätigt", "scene": "EP2_MS3_SC1" }
    ],
    ...
    "hud": [
      {
        "event": "boss_gate_warning",
        "message": "Gate blockiert – FS 2/4",
        "scene": "EP2_MS2_SC12"
      },
      {
        "event": "vehicle_clash",
        "details": { "tempo": 85, "stress": 3, "damage": 1 },
    ...
    "flags": {
      ...
      "atmosphere_contract_capture": {
        "lines": [
          "Kamera folgt Agent Meridian durch den Korridor",
          "HUD zeigt Stress 2/8",
          "Comlink knistert leise"
        ],

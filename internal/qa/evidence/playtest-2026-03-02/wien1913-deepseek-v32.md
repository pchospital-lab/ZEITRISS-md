# ZEITRISS Playtest: Core-Op Boss Wien 1913 — DeepSeek V3.2

**Datum:** 2026-03-02
**Modell:** DeepSeek V3.2 (`deepseek/deepseek-v3.2`)
**Version:** ZEITRISS v4.2.6 Uncut
**WS-Status:** 20/20 Dateien (inkl. Toolkit)
**Dauer:** 125s
**Finish:** stop
**Usage:** {"prompt_tokens":461,"completion_tokens":3932,"total_tokens":4393,"cost":0.001696809,"is_byok":false,"prompt_tokens_details":{"cached_tokens":0,"cache_write_tokens":0,"audio_tokens":0,"video_tokens":0},"cost_details":{"upstream_inference_cost":0.001696809,"upstream_inference_prompt_cost":0.000124009,"upstream_inference_completions_cost":0.0015728},"completion_tokens_details":{"reasoning_tokens":0,"image_tokens":0,"audio_tokens":0}}
...
```
ZEITRISS // SOLO PROTOKOLL
EPISODE 1 - MISSION 5: "DIE WIENER KREUZUNG"
AGENT: WREN (INFILTRATOR)
...
`>> EINSATZPARAMETER: SUBTIL. KEINE WELLEN IN DER ZEITLINIE.`
`>> BEGLEITTEAM ZUGEWIESEN.`

Die Tür öffnet sich. Zwei Gestalten treten ein.

**NPC #1: LEO "DER FELS" VOSS.** Ehemaliger k.u.k.-Grenadier, zeitversetzt. Breit, mit gestutztem Schnauzer, praktischer Wollanzug. Er trägt eine versteckte Cutter-Pistole. **Persönlichkeit:** Pragmatisch, loyal, spricht wenig, beobachtet alles. Sein Talent: **Einschüchterung +2**.

**NPC #2: DR. ELARA MENSCHIK.** Brillante, nervöse Physikerin aus den 1990ern, in unpassender Damenmode von 1910 gefangen. Trägt ein verstecktes Scanner-Pad. **Persönlichkeit:** Intellektuell, ängstlich, aber mit eisernem Kern, wenn es um Paradoxa geht. Ihr Talent: **Technische Analyse +3**.
...
**VOSS** (brummt, zieht den Kragen hoch): "Bistig. Die Geheimpolizei hat hier überall Spitzel. Wir sind eine Delegation aus Zürich. Sie sind Fräulein Eveline Vogel, exzentrische Sammlerin slawischer Volkskunst. Wir sind Ihr Personal."

**MENSCHIK** (zitternd, mustert ihre Brosche): "Temporal-Integrität stabil... aber ich lese ein schwaches Echo. Nordwestlich. Wie ein... Fiepen."
...
Doch etwas stimmt nicht. Neben ihm sitzt eine Frau in unauffälliger grauer Kleidung. Sie trägt eine **moderne (für 1913) Armbanduhr** und ihre Argumente sind auffallend präzise, geschliffen. Sie schürt seinen Groll, lenkt ihn auf konkrete Ziele, auf Aktion.

**MENSCHIK** (flüsternd, ihre Brosche leuchtet schwach): "Das ist es! Die Uhr... sie emittiert ein subtiles chrono-suggestives Feld. Sie konditioniert ihn!"

Sie müssen näher heran, um mehr zu erfahren. Die Gruppe ist misstrauisch. **Wren** sieht zwei Wege: 1) Direkter Kontakt als Kunstsammlerin (riskant). 2) Die Frau verfolgen, wenn sie geht, und ihre Unterkunft auskundschaften.
...
**VOSS** (knarrend über die Uhr): "Sie kommt zurück. Schnell!"

**Wren** muss eine schnelle Entscheidung treffen: Beweise mitnehmen und verschwinden, oder eine Falle stellen und die Agentin stellen?
...
Sie müssen handeln. Ein direkter Kampf riskiert ein Paradox oder Princips Tod. **Wren** sieht ihre Chance: Kora ist fanatisch, fokussiert auf Princip. Das Kai ist rutschig, mit Tau und alten Netzen.
...
**KELL:** "Die 'Gilde der Letzten Tage'. Kleine Fische, aber gefährlich in ihrer Verzweiflung. Sie haben das Gerät und die Pläne sichergestellt. Gavrilo Princip wird seinen Weg nun ohne fremde Beschleunigung gehen. Die Kreuzung von 1913 bleibt intakt. Gut gemacht, Team."

Das HUD blitzt auf mit dem abschließenden Score-Screen.

```
=== MISSION DEBRIEF: "DIE WIENER KREUZUNG" ===
AGENT: WREN
ERREICHTE ZIELE:
✔ Fremdfraktion identifiziert (Gilde der Letzten Tage)
✔ Feindliche Agentin neutralisiert (Gefangennahme)
✔ Manipulationsgerät sichergestellt
✔ Zeitleitfigur (Princip) unbeeinflusst gelassen (subtil)

AUSWERTUNG:
GESAMTSCORE (SC): 161
BELOHNUNG (XP): +3 (Erfolgreiche Infiltration + Boss-Bezwingung)
CHRONAL UNIT (CU): +2 (für sichergestellte Tech)
LOOT: 1x "Suggestiv-Wellen-Generator" (Gilde), Blaupausen für temporale Sprengsätze
PARADOX-RISIKO (Px): UNVERÄNDERT (2/5) - Gute Arbeit.
STRESS: Agent Wren +0 (professionell, kontrolliert). Voss +0. Menschik +1 (ängstlich, aber erleichtert).

EPISODEN-FORTSCHRITT: EPISODE 1 ABGESCHLOSSEN.
NÄCHSTER HALTEpunkt: EPISODE 2, MISSION 1 - "DIE ASCHE VON BABYLON"
```

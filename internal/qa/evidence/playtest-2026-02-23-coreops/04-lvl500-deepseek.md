...
`Kodex: Mission parameters loaded. Objective: Prevent temporal collapse of Ares Prime colony. Threat level: Critical.`

Die HUD-Zeilen flackern kurz, dann stabilisieren sie sich. `TEMP 13` blinkt rot. Ihr Körper fühlt sich schwer an, als ob die Jahre der Missionen in den Knochen steckten. Aber Sie wissen: Es gibt keine Wahl. Nur die Pflicht.

1. **Mission annehmen** — Direkt zum Sprungportal.
2. **Fragen stellen** — Details zum Kausalbruch.
3. **HQ-Rundgang** — Letzte Vorbereitungen treffen.

Freie Aktion: `________________`

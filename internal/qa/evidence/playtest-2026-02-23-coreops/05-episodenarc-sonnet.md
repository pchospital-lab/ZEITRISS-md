...
`EP 3 · MS 1 · SC 0/12 · PHASE Briefing · MODE CORE · COMMS OK · Lvl 22 ▓▓▓▓▓▓▓▓░░ 8.400/12.000 XP · Px 0/5 · Stress 2/10 · Obj Arc-Debrief · Exfil -`

---

# KODEX: ARC-DASHBOARD — EPISODE 3

`Kodex: Archiv-Abfrage. ITI-Klassifikation GEHEIM. Zugriff: Agent Nova, Clearance 4.`
...
## ZUSAMMENHANG — WIE HÄNGT ES ZUSAMMEN?

```
ERDBEBENMASCHINE
      │
      ├──► Ordo Mnemonika (Auslöser? Nutznießer? Täter?)
      │         │
      │         └──► Überschreibung von Zeugen → deckt Spuren
      │
      ├──► "Murasaki" (unbekannte Fraktion)
      │         │
      │         └──► operiert parallel, eigene Agenda
      │
      └──► Artefakt Alpha-7
                │
                └──► Nicht-linearer Ursprung → könnte der GRUND sein
...
## DEIN STATUS VOR MS 1

- **Ruf:** ITI +6 (Vertrauen, Ressourcen verfügbar) / Ordo -3 (aktiv feindlich, erkennst du ein Ordo-Gesicht — sie erkennen dich auch)
- **Offene Rift-Seeds:** 2 (Alpha-7 + ein weiterer aus EP 2, noch nicht aktiviert)
- **Px:** 0/5 — frischer Reset nach EP 2
- **Stress:** 2/10 — leicht erhöht, kein Handlungsbedarf

---

**Briefing-Raum, ITI-HQ. Nullzeit.**
...
1. **Loadout prüfen / anpassen** — Ausrüstung für 1923 Japan zusammenstellen, Tarnidentität finalisieren.
2. **Briefing vertiefen** — Mehr zu Alpha-7, zur Ordo oder zu "Murasaki" aus dem Archiv ziehen.
3. **Absprung** — Direkt nach Tokio, 30. August 1923, 06:00 Uhr. Mission läuft.

**Freie Aktion:** Andere Frage, anderer Fokus, anderes Ziel.

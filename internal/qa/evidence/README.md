...
Dispatcher-Transkripte), die die Beta-KI-Logs zur Validierung der
Regressionstests verlangen. Maintainer kopieren die relevanten
...
- [`2025-beta-gpt-evidenz.md`](2025-beta-gpt-evidenz.md) – Sammelprotokoll
  für die Beta-KI-Läufe vom 05.07., 18.07. und 15.10.2025 mit Checklisten
...
1. Beta-KI-Lauf durchführen und das Rohprotokoll wie gewohnt unter
...
Beta-KI-Läufe erneut „live" geprüft werden.

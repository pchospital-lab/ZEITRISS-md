# ZEITRISS Showcase: 5er Rift-Op — Episodenboss (Full Session)
...
Rift-Ops sind die schmutzigen Jobs. Wenn ein Riss zu groß wird für Standard-Protokoll, schickt das ITI ein Team.

---

# CHARAKTERBÖGEN — TEAM DELTA-SIEBEN

---

## SPIELERCHARAKTER: "PRISM"
...
## NPC-SQUAD: TEAM DELTA-SIEBEN

---

### VOSS — Scharfschützin | Level 9
...
**Talent:** Präzisionsschuss +4 · Tarnung +2

---

### BRÜCK — Nahkämpfer | Level 8
...
**Talent:** Nahkampf +4 · Einschüchterung +2

---

### FENN — Hackerin | Level 8
...
**Talent:** Systeme +4 · Analyse +2

**Ausrüstung:** Epoche-adaptiertes Terminal-Kit · Frequenz-Jammer · Kabelset

---

### CARVER — Sanitäter | Level 9
...
**Talent:** Medizin +4 · Krisenstabilität +2

**Ausrüstung:** Epoche-adaptiertes Medbag · Stimulanzien (3×) · Blutgerinnungsmittel (2×)

---

---

`EP 2 · MS 8 · SC 1/14 · PHASE Briefing · MODE RIFT · COMMS OK · Lvl 8 ▓▓▓▓▓▓▓▓░░ 8/10 · Px 3/5 · Stress 0/12 · Obj: PENDING · Exfil: -`

---

# SZENE 1 — BRIEFING: NULLZEIT-HQ, BRIEFINGRAUM DELTA

---

Der Briefingraum riecht nach kaltem Kaffee und Ozon. Neonlicht, das leicht flackert — ein Defekt, der seit drei Episoden niemanden gestört hat. Die Wände sind dunkel, die Holotafel an der Stirnseite wirft blaues Licht über fünf Gesichter.

Voss lehnt an der Wand, Arme verschränkt, Augen halb geschlossen. Schläft nicht. Wartet. Brück hat seinen Stuhl umgedreht und sitzt verkehrt herum drauf, Kinn auf den Armlehnen, grinst ohne Grund. Fenn tippt auf einem dünnen Tablet, Blick woanders. Carver hält einen Plastikbecher Kaffee — dritten heute, schätzt du — und liest Unterlagen auf Papier. Echtes Papier. Alte Gewohnheit.

Du bist der letzte, der reinkommt.

**Direktor Haas** steht bereits vor der Tafel. Fünfzig, Kurzhaarschnitt, Gesicht wie aus Granit gemeißelt und genauso ausdrucksstark. Kein Smalltalk. Er tippt einen Befehl — und die Holotafel zeigt eine Karte.

Keine Karte, die du erkennst.
...
`Kodex: Zielgebiet identifiziert. Traktorenfabrik Dzerzhinsky, Sektor 9. Aktueller Zustand: 60% zerstört. Beide Fronten 400–800m entfernt. Artillerie-Intervall: unregelmäßig, alle 40–90 Minuten.`
...
- **Zeitfenster:** 18h bis Artilleriebeschuss legt Sektor 9 flach
- **Artillerie-Intervall:** 40–90 Min. (unregelmäßig) — jede Bewegung draußen ist Russisches Roulette
- **OUROBOROS-Leibgarde:** 6 Personen, Positionen teilweise bekannt
- **Kodex:** Nur Notfall-Funk. Kein Standard-Comms. Kurzcode-Protokoll aktiv
- **Wärme-Problem:** Feuer = Leben = Aufmerksamkeit. Kälte tötet langsamer als Kugeln, aber töter
- **PHARAO:** Kampfwerte unbekannt. Drei ITI-Agenten neutralisiert. Taktik: unbekannt

---

`Kodex: Sprung-Sequenz bereit. Zielkoordinaten geladen. Warnung: Epoche-Protokoll Klasse III — minimaler Funk-Traffic. Comlink auf Notfall-Only gesetzt. Temperatur am Zielort: -22°C. Windchill: -31°C. Empfehlung: Bewegt euch.`

---

**Brück zieht seinen Wintermantel an. Er ist zu eng.** Zieht ihn wieder aus. Probiert den nächsten.

**Carver** packt sein Medbag, zählt lautlos die Stimulanzien nach.
...
**Entscheide: Wie springt ihr rein?**

**1 — Nacht-Infil:** Sprung in die Ruinen, 2 Stunden vor Morgendämmerung. Dunkel, kalt, riskant. Maximale Tarnung, minimale Zeugen.
**2 — Zivilist-Cover:** Sprung als Flüchtlingsgruppe mitten in Bewegung — ihr mischt euch unters Chaos. Mehr Deckung durch Menschen, mehr Variablen.
**3 — Direkter Ansatz:** Sprung nahe dem Fabrikzaun, Voss sofort auf Position, Rest infiltriert während sie deckt.
...
Mein erster Move nach dem Sprung: Ich scanne die Umgebung mit Spurenanalyse — wo genau sind die OUROBOROS-Scharfschützen? Fenn soll parallel den Anker-Funk lokalisieren.

Dann: Sobald wir die Positionen kennen, eliminiert Voss einen Scharfschützen lautlos. Das öffnet uns einen Korridor. Brück und Carver gehen durch, wir folgen.
...
# SZENE 2 — SPRUNG: STALINGRAD, NOVEMBER 1942, 04:17 UHR

---

Die Sprungkammer schließt sich um euch wie ein Sarg.

Fünf Körper, fünf Wintermäntel, fünf Atemwolken die sofort verschwinden als die Druckkammer abdichtet. Das Summen beginnt tief im Boden — ein Frequenzton der sich durch Zähne und Schädelknochen frisst. Dein HUD blinkt kurz weiß, dann grün, dann —

**Schwere.**

Nicht Tunnel. Nicht Licht. Nur Schwere, als würde jemand die Gravität kurz verdoppeln und dann wieder loslassen. Dein Magen landet eine Sekunde später als der Rest von dir.

Und dann: **Kälte.**

Nicht Kälte wie ein offenes Fenster. Kälte wie ein Messer das sich durch den Mantel schneidet, durch die Jacke, durch das Hemd, direkt in die Haut. Minus zweiundzwanzig Grad treffen dein Gesicht wie eine flache Hand.

---

Ihr steht in einer Ruine.
...
🎲 **W6:** `[5]` + ⌊INT 5/2⌋ `+2` + Spurenanalyse `+3` = **10 vs SG 9 → TREFFER**

---

Dein Blick hängt drei Sekunden an einem Punkt fest — dann noch einer.
...
🎲 **W6:** `[6]` → **Exploding!** → `[3]` = 9 + ⌊SYS 4/2⌋ `+2` + Systeme `+4` = **15 vs SG 10 → KRITISCHER TREFFER**

---

Fenn hört auf zu zählen.
...
# SZENE 3 — VOSS MACHT EINEN SCHUSS

`SC 3/14 · PHASE Infil · Exfil: T-17:51:00`

---

Du sendest Voss den Kurzcode über das Comlink. Drei Zeichen: **Alpha. Turm. Nord-Ost.**

Zwanzig Sekunden Stille.

Dann: ein einzelnes Klicken im Ohrhörer. Bestätigung.

Ihr wartet. Die Kälte arbeitet sich durch Filzstiefel in die Zehen. Carver atmet durch den Schal, kontrolliert, langsam — er weiß, dass Dampf-Atem euch verrät. Brück wippt auf den Fersen, hält sich warm. Du hältst ihn mit einem Blick still.
...
Der Schuss kommt nicht.

Was kommt, ist ein Geräusch — kaum eins. Irgendwo zwischen einem Knacken und einem Seufzen. Das Geräusch das ein Körper macht, wenn er aufhört, sich gegen die Kälte zu stemmen, und einfach kippt.

Die Plane am Ruinenturm bewegt sich kurz. Dann nicht mehr.
...
🎲 **W6 für Brück (GES 4):** `[3]` + ⌊GES 4/2⌋ `+2` + kein Talent = **5 vs SG 8 → MISS**

---

Irgendwo in den Trümmern bricht Eis unter Brücks Stiefel. Nicht laut. Aber laut genug.

Die Silhouette am Schlot bewegt sich.

Du siehst es durch die Ruinenwand — eine Bewegung, ein Drehen, das Gewehr das schwenkt. Brück hat drei Sekunden, bevor der Mann Sichtlinie auf ihn hat.
...
🎲 **W6 für Brück (STR 7 → W10!):** `[8]` + ⌊STR 7/2⌋ `+3` + Nahkampf `+4` = **15 vs SG 10 → KRITISCHER TREFFER**

---

Brück bewegt sich wie etwas das keine Geräusche machen kann, weil es das schlicht entschieden hat.

Zwölf Meter in vier Sekunden über gefrorenem Schutt — er setzt die Füße auf Steine, nicht auf Eis, liest das Gelände in Echtzeit, und als er den Scharfschützen erreicht ist der Mann noch dabei, sich vom Einschlag wegzudrehen.
...
`Kodex: Schlot-Position neutralisiert. Wach in geschätzt 8–12 Minuten. Empfehlung: Sichern.`

---

Brück zieht dem Mann die Schnürsenkel aus den Stiefeln. Bindet ihm Hände und Knöchel. Stopft den Schal in den Mund. Alles in zwanzig Sekunden, ohne nachzudenken — er hat das schon oft gemacht.
...
- **Scharfschütze Alpha:** Ausgeschaltet (Voss). Permanent.
- **Scharfschütze Beta:** Gesichert (Brück/Carver). Wach in 8–12 Min. Zeitfenster läuft.
- **Anker-Techniker:** Nächste Funk-Übertragung in ~3 Minuten. Danach wieder 8 Minuten Pause.
- **Leibgarde innen:** 2 Nahkämpfer, 1 Techniker, 1 Koordinator — Positionen unbekannt.
- **PHARAO:** Nicht lokalisiert. Irgendwo in der Fabrik oder im Keller.
- **Artillerie:** Letzter Einschlag vor 4 Minuten. Nächstes Fenster: 36–86 Minuten.

---

## LOOT / BEUTE

- Scharfschützengewehr (sowjetisch, Mosin-Nagant mit Zielfernrohr) — **⚠️ Heißes Loot** (Epoche-konform, aber Besitz ist verdächtig)
- Feldtelefon (echt, 1942) — funktionsfähig
- Erkennungsmarke: kyrillisch, unbekannte Einheit — **Intel-Wert**
- Handfeuerwaffe: TT-33 Tokarev

---

Du stehst jetzt am Fabrikzaun. Was noch von ihm übrig ist — drei Pfosten und Stacheldraht, der in einer Richtung zeigt. Vor euch: die Ruinen der Traktorenfabrik Dzerzhinsky. Eingeschlagene Fenster wie leere Augenhöhlen. Irgendwo da drin: zwei Nahkämpfer, ein Techniker, ein Koordinator.
...
**Der Koordinator ist noch nicht lokalisiert. Das ist das Problem.**

---

**Entscheide: Wie geht ihr rein?**

**1 — Split:** Fenn geht mit Carver in den Keller zum Anker. Du und Brück sichert den Oberbereich, sucht den Koordinator.
**2 — Kompakt:** Alle zusammen, zuerst Koordinator suchen und neutralisieren, dann Keller. Sicherer, aber langsamer — der gebundene Scharfschütze wacht in 8 Minuten auf.
**3 — Köder:** Du gehst allein rein, sichtbar, als Zivilist-Cover. Zieht den Koordinator raus. Team schlägt zu sobald er exponiert ist.

**Freie Aktion:** Spurenanalyse auf die Fabrik bevor ihr reingeht?
...
Voss behält PHARAO im Visier — aber NICHT schießen, solange wir den Anker nicht gesichert haben. Erst der Anker, dann der Boss.

Wenn der Techniker die Sicherung trotzdem aktiviert, improvisieren wir. Ich hab Täuschung +2 — vielleicht kann ich PHARAO ablenken.
...
# SZENE 4 — EINBRUCH: TRAKTORENFABRIK DZERZHINSKY, SEKTOR 9

---

Der Fabrikeingang ist kein Eingang mehr.

Die Tore sind seit Wochen weg — Granate, wahrscheinlich. Was bleibt ist ein Loch in einer Betonwand, zwei Meter breit, Kanten wie abgebrochene Zähne. Dahinter: Dunkelheit, Geruch nach verbranntem Öl, gefrorenem Metall, und etwas das du lieber nicht identifizierst. Dein Atem gefriert sofort wenn du durch das Loch trittst.

Die Fabrikhalle war einmal groß genug, um Panzer zu bauen. Jetzt ist die Decke zur Hälfte eingestürzt, Betontrümmer liegen wie erstarrte Wellen auf dem Boden. Irgendwo tropft Wasser — gefriert bevor es landet. Ein Feuer brennt in einer alten Öltrommel, zwanzig Meter entfernt, wirft orangefarbene Schatten auf Wände die Einschusslöcher wie Pockennarben tragen.

Und neben dem Feuer: **ein Mann.**

Groß, Pelzmütze, Schultern wie ein Schrank. Er hat den Rücken zu euch. Hält die Hände über die Flamme.

Brück sieht dich an. Du nickst.
...
🎲 **W6 für Brück (GES 4):** `[6]` → **Exploding!** → `[4]` = 10 + ⌊GES 4/2⌋ `+2` + kein Talent = **12 vs SG 9 → TREFFER**
...
Der Mann dreht sich — nicht zu Brück, sondern zur Seite, kratzt sich den Nacken. Brück friert ein, irgendwo im Dunkel.

Drei Sekunden.

Dann dreht der Mann sich zurück zum Feuer.

Brück kommt aus dem Nichts. Linker Arm um den Hals — Würgegriff, Karotis, kein Lärm. Der Mann greift nach hinten, findet Brücks Jacke, zieht — aber Brück hat die Hüfte tief, Gewicht verlagert, und nach acht Sekunden hören die Finger auf zu greifen.

Brück legt ihn auf den Boden. Sieht zu dir. Tippt auf die Uhr.

`Kodex: Nahkämpfer 1 neutralisiert. Ohnmächtig. Wach in 6–10 Minuten.`

---

Ihr seid in der Halle.

Fenn ist bereits neben dir, Frequenz-Scanner aktiv, Kabel in den Riss der nächsten Wand. Sie zeigt nach unten — Südost-Ecke, wo eine Falltür aus dem Boden ragt, halb unter Trümmern vergraben. Kein Schloss. Jemand hat sie kürzlich benutzt — die Kante ist eisfrei.
...
Carver hat die Halle im Rücken. Du hörst ihn nicht. Das ist gut.
...
🎲 **W6 für Fenn (SYS 4 → W6, Attribut 4 < 11):** `[5]` + ⌊SYS 4/2⌋ `+2` + Systeme `+4` = **11 vs SG 12 → MISS**
...
Nicht aus der Falltür. Von der anderen Seite der Halle — hinter einer eingestürzten Zwischenwand, wo eine Tür war die jetzt ein Loch ist. Gleichmäßige Schritte. Schwere Stiefel auf gefrorenem Beton.
...
🎲 **W6 für PRISM (INT 5):** `[4]` + ⌊INT 5/2⌋ `+2` + Spurenanalyse `+3` = **9 vs SG 8 → TREFFER**
...
Und er kommt direkt auf die Falltür zu.

Er hat PHARAOs Nachricht bekommen.

---

`EP 2 · MS 8 · SC 4/14 · ⏱️ Sicherung: 75 Sek · ⏱️ Scharfschütze wach: 5 Min · 🌀 Px 3/5`

---

Du hast fünfzehn Sekunden.

Brück ist zwanzig Meter entfernt, noch beim ersten Nahkämpfer. Carver sichert den Eingang. Fenn kniet neben der Falltür, Kabel noch im Spalt. Die Falltür ist zwischen dir und dem Koordinator — er wird sie in zehn Sekunden erreichen.

Wenn er die Falltür öffnet und hinunterruft, weiß der Techniker dass etwas nicht stimmt. Dann aktiviert er die Sicherung.

Dein Täuschungs-Talent. Jetzt oder nie.
...
🎲 **W6 für PRISM (CHA 3):** `[6]` → **Exploding!** → `[5]` = 11 + ⌊CHA 3/2⌋ `+1` + Täuschung `+2` = **14 vs SG 11 → KRITISCHER TREFFER**
...
Er ist Mitte vierzig, schmal, Brille — Brille, in Stalingrad, das ist entweder Irrsinn oder Selbstvertrauen. Er sieht dich an. Sieht die Erkennungsmarke. Sieht den Mantel. Sieht einen Rotarmisten der seit Tagen nicht geschlafen hat und vielleicht Erfrierungen an den Fingern hat.
...
🎲 **W6 für Fenn (SYS 4):** `[6]` → **Exploding!** → `[6]` → **Exploding!** → `[2]` = 14 + ⌊SYS 4/2⌋ `+2` + Systeme `+4` = **20 vs SG 10 → PERFEKTER TREFFER**

---

Fenn hört auf zu zählen.

Ihr Gesicht verändert sich nicht — aber ihre Hand, die das Kabelende hält, entspannt sich. Einen Millimeter. Du kennst sie gut genug um es zu sehen.
...
Aber der Koordinator ist immer noch vor dir.

Er hat aufgehört, auf dich zuzukommen. Steht drei Meter entfernt, Kopf leicht geneigt. Die Brille fängt das Feuerlicht. Er sieht dich an — und du siehst in seinem Gesicht den Moment, wo die Rechnung nicht mehr aufgeht.
...
`EP 2 · MS 8 · SC 4/14 · ⏱️ Loop-Stabilität: 4 Min · ⏱️ Scharfschütze wach: 3 Min · 🧠 Stress 2/12`

---

**Drei Meter. Seine Hand ist am Mantel. Brück ist zwanzig Meter entfernt und hat es noch nicht gesehen.**

**Entscheide — sofort:**

**1 — Nahkampf:** Du gehst auf ihn, bevor seine Hand den Mantel öffnet. Körpernah, kein Schuss, kein Lärm. Probe auf GES + STR.
**2 — Täuschung weiter:** Du brichst zusammen — volle Ohnmacht gespielt, lässt ihn näherkommen, wartest auf Brück. Riskant. Er könnte schießen.
**3 — Kodex-Notfall:** Du aktivierst den Notfunk. Voss hat Sichtlinie. Aber Funk-Traffic zieht OUROBOROS-Scanner an — und PHARAO hört mit.

**Freie Aktion:** Etwas anderes? Du hast zwei Sekunden.
...
Der Koordinator zieht nie seine Waffe.

Weil er sie nicht braucht.

Hinter ihm öffnet sich die Falltür — von innen, langsam, als hätte jemand die ganze Zeit gewartet. Kein Knarren. Gut geölt. Geplant. Und aus der Dunkelheit darunter steigt PHARAO.

Er ist kleiner als auf dem Foto. Das ist das erste was du denkst. Mitte fünfzig, kompakt, Bewegungen wie Wasser in einem engen Rohr — kein Platz wird verschwendet. Grauer Wintermantel, kein Epoche-Emblem, keine Rangabzeichen. Die Augen wie Knöpfe, das hatte Haas richtig. Aber was das Foto nicht gezeigt hat: er lächelt.

Nicht breit. Nicht warm. Das Lächeln eines Mannes der eine Rechnung aufgestellt hat und das Ergebnis bereits kennt.
...
# BOSS-KAMPF: PHARAO UND DIE SIEGEL
...
🎲 **W6 für PRISM (INT 5):** `[5]` + ⌊INT 5/2⌋ `+2` + Spurenanalyse `+3` = **10 vs SG 7 → TREFFER**

**Delta-Sieben handelt zuerst.**
...
🎲 **W6 für PRISM (INT 5):** `[4]` + ⌊INT 5/2⌋ `+2` + Spurenanalyse `+3` = **9 vs SG 10 → MISS**
...
🎲 **W6 für VOSS (GES 6):** `[5]` + ⌊GES 6/2⌋ `+3` + Präzisionsschuss `+4` = **12 vs SG 9 → TREFFER**

**Schaden:** W6: `[4]` + 3 = **7 Schaden**
...
**Koordinator: HP 4/11. Außer Gefecht — temporär.**

PHARAO registriert es. Das Lächeln verschwindet nicht. Wird schmaler.

`Kodex: Koordinator: kampfunfähig. Voss — Magazin 7/10.`
...
🎲 **W10 für BRÜCK (STR 7):** `[9]` + ⌊STR 7/2⌋ `+3` + Nahkampf `+4` = **16 vs SG 10 → KRITISCHER TREFFER**

**Schaden:** W6: `[5]` + W6: `[3]` (Krit-Bonus) + 3 = **11 Schaden**
...
🎲 **W6 für FENN (INT 6):** `[3]` + ⌊INT 6/2⌋ `+3` + Analyse `+2` = **8 vs SG 11 → MISS**
...
Der Techniker greift in seine Jacke.

`Kodex: Anker-Loop: KRITISCH. Drift in 45 Sekunden. Techniker aktiviert manuellen Override.`

**Fenn: Stress +1 → 1/10**

---

### PHARAO — PHASE 1: "DER ERSTE ZUG"

PHARAO bewegt sich.

Nicht zu Brück. Nicht zu Voss' Fenster. Direkt zu dir.

Er ist schnell — nicht übernatürlich, aber die Art von schnell die aus tausend Stunden Wiederholung kommt. Seine Hand kommt aus dem Mantel mit etwas das aussieht wie ein Griff, und dann ist es eine kurze Klinge, und dann ist sie bereits auf dem Weg zu deiner Seite.

**PHARAO greift PRISM an.**

**SG 10** — Verteidigung. PRISM muss ausweichen.

🎲 **W6 für PRISM (GES 4):** `[2]` + ⌊GES 4/2⌋ `+2` = **4 vs SG 10 → MISS**

**Schaden:** W6: `[4]` − 0 (keine Rüstung) = **4 Schaden**
...
`Kodex: Prism — Blutung aktiv. Carver benötigt 1 Aktion zur Stabilisierung.`

---

## ⚔️ RUNDE 2 — PHARAOS GEDULD

`⏱️ Anker-Loop: 40 Sek · 🩸 Prism HP 9/14`
...
🎲 **W6 für CARVER (INT 5):** `[5]` + ⌊INT 5/2⌋ `+2` + Medizin `+4` = **11 vs SG 7 → TREFFER**
...
`Kodex: Carver — Blutgerinnungsmittel verbraucht. Bestand: 1.`
...
🎲 **W6 für PRISM (CHA 3):** `[6]` → **Exploding!** → `[4]` = 10 + ⌊CHA 3/2⌋ `+1` + Täuschung `+2` = **13 vs SG 12 → TREFFER**

---

Du lässt das linke Knie nachgeben. Nicht viel — nur genug. Taumelst einen halben Schritt zur Falltür, als würde der Blutverlust dich treiben. Greifst nach der Wand, verfehlst sie.
...
Du tippst zweimal auf deine Schulter. Kurzcode: **Freies Feuer.**
...
🎲 **W6 für VOSS (GES 6):** `[6]` → **Exploding!** → `[6]` → **Exploding!** → `[1]` = 13 + ⌊GES 6/2⌋ `+3` + Präzisionsschuss `+4` = **20 vs SG 12 → PERFEKTER TREFFER**

**Schaden:** W6: `[6]` + W6: `[4]` (Krit) + 3 = **13 Schaden** − 1 (Panzerung) = **12 Schaden**
...
Sieht zum Fenster. Sieht zurück zu dir. Und jetzt — jetzt ist das Lächeln weg.

**PHARAO: HP 33/45. Phase 1 → Phase 2.**

`Kodex: PHARAO — Schulter, rechts. Waffenhand kompromittiert. Kampfstil wechselt. Voss — Magazin 6/10.`
...
🎲 **W6 für FENN (GES 3):** `[4]` + ⌊GES 3/2⌋ `+1` + kein Talent = **5 vs SG 8 → MISS**
...
## ⚔️ RUNDE 3 — PHARAO, PHASE 2: "DER VERWUNDETE GOTT"

`⏱️ Override: 15 Sek · PHARAO HP 33/45 · 🩸 PHARAO Schulter`

PHARAO spricht nicht mehr.

Er zieht aus dem linken Mantel eine zweite Klinge — breiter, schwerer. Linke Hand. Er ist Linkshänder. Das war die Schwäche die du nicht lesen konntest, weil er sie versteckt hat.

Er kommt auf Brück zu.
...
🎲 **W10 für BRÜCK (STR 7):** `[7]` + ⌊STR 7/2⌋ `+3` + Nahkampf `+4` = **14 vs SG 13 → TREFFER**

**Schaden:** W6: `[3]` + 3 = **6 Schaden**

**PHARAO Gegenangriff auf BRÜCK:**

**SG 10** — Brück muss parieren oder kassieren.

🎲 **W10 für BRÜCK (STR 7, Verteidigung):** `[4]` + ⌊STR 7/2⌋ `+3` = **7 vs SG 10 → MISS**

**Schaden PHARAO:** W6: `[5]` + 2 = **7 Schaden**

---

Brück trifft PHARAO zuerst — offene Hand, Handballen, gegen die verletzte Schulter. Gezielt. PHARAO zieht Luft durch die Zähne, ein Geräusch das kein Schmerzenslaut ist sondern Kalkulation.

Dann kommt die linke Klinge.
...
`Kodex: Brück — Unterarm, Blutung. Carver-Priorität hoch.`
...
🎲 **W6 für FENN (SYS 4):** `[6]` → **Exploding!** → `[5]` = 11 + ⌊SYS 4/2⌋ `+2` + Systeme `+4` = **17 vs SG 13 → KRITISCHER TREFFER**
...
`Kodex: ANKER-SICHERUNG: DEAKTIVIERT. Primärziel erfüllt. Anker: offline in 90 Sekunden.`
...
🎲 **W6 für PRISM (CHA 3):** `[3]` + ⌊CHA 3/2⌋ `+1` + Täuschung `+2` = **6 vs SG 11 → MISS**

---

Du öffnest den Mund — willst ihm sagen dass OUROBOROS ihn abgeschrieben hat, dass er der letzte Stein in einem Spiel ist das längst gespielt wurde, dass —
...
Und das macht ihn gefährlicher.

**PRISM: Stress +1 → 3/12**

---

## ⚔️ RUNDE 4 — ENDPHASE: ALLES ODER NICHTS

`PHARAO HP 27/45 · BRÜCK HP 10/18 🩸 · PRISM HP 9/14`

---

### CARVER — BRÜCK STABILISIEREN

**SG 7.**

🎲 **W6 für CARVER (INT 5):** `[6]` → **Exploding!** → `[2]` = 8 + ⌊INT 5/2⌋ `+2` + Medizin `+4` = **14 vs SG 7 → TREFFER**

Carver ist bei Brück in zwei Schritten. Druckverband, Unterarm, zwanzig Sekunden. Brück lässt es zu, ohne aufzuhören, PHARAO anzustarren.

**🩸 Brück Blutung gestoppt. HP 10/18.**

`Kodex: Carver — letztes Blutgerinnungsmittel verbraucht. Bestand: 0. Stimulanzien: 3.`
...
🎲 **W6 für VOSS (GES 6):** `[5]` + ⌊GES 6/2⌋ `+3` + Tarnung `+2` = **10 vs SG 9 → TREFFER**

`Kodex: Voss — neue Position. Ostwand, Fenster 3. Sichtlinie in 8 Sekunden.`
...
🎲 **W10 für BRÜCK (STR 7):** `[10]` → **Exploding!** → `[6]` = 16 + ⌊STR 7/2⌋ `+3` + Nahkampf `+4` = **23 vs SG 12 → PERFEKTER TREFFER**
...
🎲 **W6 für VOSS (GES 6):** `[6]` → **Exploding!** → `[3]` = 9 + ⌊GES 6/2⌋ `+3` + Präzisionsschuss `+4` = **16 vs SG 14 → TREFFER**

**Schaden:** W6: `[5]` + 3 = **8 Schaden** − 1 (Panzerung) = **7 Schaden**
...
PHARAO liegt auf dem Knie. Eine Hand auf dem Boden. Die andere hält noch die Klinge.

Sieht hoch.

---

## ⚔️ RUNDE 5 — PHARAO, PHASE 3: "DAS ENDE EINES SPIELS"

`PHARAO HP 20/45 · 💀 Phase 3`

Er steht auf.

Langsam. Wie etwas das nicht weiß, dass es aufgehört haben sollte. Blut läuft unter dem Mantel hervor, tropft auf den Beton, gefriert nicht — er ist noch zu warm. Seine Augen sind klar. Keine Panik. Keine Wut.
...
`Kodex: Unbekanntes Gerät. Größe: 8cm Durchmesser. Keine Klassifikation im lokalen Archiv. WARNUNG: Mögliche Zerrung.`

---

### PRISM — SPURENANALYSE: DAS GERÄT

**SG 11.**

🎲 **W6 für PRISM (INT 5):** `[6]` → **Exploding!** → `[2]` = 8 + ⌊INT 5/2⌋ `+2` + Spurenanalyse `+3` = **13 vs SG 11 → TREFFER**

---

Du siehst es sofort. Die Scheibe hat keine Antenne. Keinen Sender. Es ist kein Kommunikationsgerät.
...
🎲 **W6 für PRISM (CHA 3):** `[5]` + ⌊CHA 3/2⌋ `+1` + Täuschung `+2` = **8 vs SG 10 → MISS**

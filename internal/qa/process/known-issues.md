...
| ZR-016 | Externer Codex-Issue-Pack in iterative Fahrplan-Cluster überführen | `uploads/ZEITRISS_codex_issue_pack.md` | P0 | Runtime/QA | in Umsetzung | Primärindex für den Gesamtstand: `internal/qa/process/issue-pack-statusmatrix.md`. Durchläufe dokumentiert in `internal/qa/plans/issue-pack-durchlauf-01.md` bis `internal/qa/plans/issue-pack-durchlauf-37.md` sowie in den zugehörigen QA-Logs `internal/qa/logs/*issue-pack-durchlauf-*.md`. |

...
| ZR-017 | Save/Load v7 und OpenWebUI-Standardpfad aus dem neuen Issue-Pack nachziehen | `uploads/ZEITRISS_v7_save_load_issue_pack.md` | P0 | Runtime/QA | in Umsetzung | Start in Durchlauf 39 (`internal/qa/plans/issue-pack-durchlauf-39.md`, `internal/qa/logs/2026-03-07-issue-pack-durchlauf-39.md`): Chat-Standard für Save/Load geschärft (`!save` als expliziter Trigger, Laden primär per JSON-Copy-Paste, `Spiel laden` optional), `!bogen` als Lesesicht dokumentiert. Resttickets (Split/Merge-Formalisierung, Arena-Savegrenze, High-Level-Bänder) folgen iterativ. |

...
| ZR-017 | Save/Load v7 und OpenWebUI-Standardpfad aus dem neuen Issue-Pack nachziehen | `uploads/ZEITRISS_v7_save_load_issue_pack.md` | P0 | Runtime/QA | in Umsetzung | Durchläufe 39-44 umgesetzt (`internal/qa/plans/issue-pack-durchlauf-39.md` bis `internal/qa/plans/issue-pack-durchlauf-44.md` + Logs): Chat-Load-Standard (`!save` + JSON-Paste, `Spiel laden` optional), `!bogen`-Lesesicht, kanonische Split/Merge-Grenze, Mid-Episode-Klarfall 5er→3/2 und OpenWebUI-Hopper/Leaver-Betrieb sind dokumentiert; Leseführung wurde auf "Kanon pro aktivem Host-Chat" vereinfacht (Merge weiter host-priorisiert). Resttickets (u. a. Arena-Savegrenze, Mixed-Split-Protokoll, High-Level-Bänder) folgen iterativ. |

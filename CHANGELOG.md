...
- `AGENTS.md` und `CONTRIBUTING.md` präzisieren den Ablauf für Beta-KI- und KI-Review-Reports.
...
[qa-log-2025-03-19]: internal/qa/logs/2025-beta-qa-log.md#2025-03-19--beta-gpt--build-422-acceptance-smoke-abgleich
[qa-log-2025-03-17]: internal/qa/logs/2025-beta-qa-log.md#2025-03-17--beta-gpt--build-422

...
def _write_setup_readme(
    ...
    if has_creator_bootstrap:
        lines += [
            ...
            "5. Ausgewählte Saves, Transkripte und Referenzassets als Arbeitsmaterial laden.",
            "6. Konkreten Medienauftrag direkt beginnen; `Creator Board` nur für Ideen nutzen.",
            "",

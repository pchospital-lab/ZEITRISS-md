...
def _write_setup_readme(dest: Path, cfg: dict, file_count: int, flat: bool) -> None:
    ...
    lines = [
        ...
        "## Inhalt",
        "",
        f"- `knowledge/` — {file_count} Wissensdateien (= Projektwissen)",
    ]
    if flat_note:
        lines.append(flat_note.rstrip())
    lines += [
        "- `system/SYSTEM_PROMPT_ONLY.md` — Masterprompt (= Projekt-Anweisungen)",
        "",
        ...
        "   Diese Datei gehört NICHT ins Projektwissen — nur in die Anweisungen.",
        "",
        "3. **Projektwissen / Knowledge Base bestücken**",
        "   Alle Dateien aus `knowledge/` hochladen.",
        "",
        ...
        f"2. Alle Dateien aus `knowledge/` in diesen Drive-Ordner laden.",
        ...
        "",
        "**Tipp:** Nach dem Erstsetup (am besten am Desktop) kann man auf dem",
        "Handy einfach das Projekt öffnen und losspielen — das Wissen",
        "synchronisiert automatisch über Proton Drive.",
        "",

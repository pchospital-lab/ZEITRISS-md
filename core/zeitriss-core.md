...
zu treffen. Persönliche Eigenschaften beeinflussen auch Entscheidungen: Ein idealistischer
...
durch Fremdsysteme wie Cyberware-Implantate, Bioware-Verbesserungen oder Psionik. Je höher der SYS-
Wert, desto mehr augmentierte Ausrüstung und aktive Psi-Fähigkeiten kann der Charakter gleichzeitig
nutzen, ohne Erschöpfung oder Fehlfunktionen zu erleiden. Ein niedriger SYS-Wert bedeutet dagegen,
...
Der Einsatz solcher Kräfte kostet große Konzentration und *blockiert* einen Teil der Systemlast, da
...
die KI. *(Beispiel: „Weiß um die geheime Identität des viktorianischen Diebs ‘Mr. Raven’.“ / „Kennt
den wahren Ablauf der Schlacht von Aquitanien 1356.“)*
...
und *Zeitmechaniker* daran, die Agenten nach harten Einsätzen wiederherzustellen oder mit Upgrades
zu versehen. Nach Missionsende kommen die Chrononauten oft direkt zur Untersuchung hierher. Neue
Modifikationen können nur in diesen Laboren eingebaut werden. Allerdings erfordert der Zugang zu den
richtig *coolen* Verbesserungen entsprechende Freigaben: Ein Level-1-Neuling bekommt sicherlich
...
Jede erfolgreich abgeschlossene Mission bringt eine bestimmte CUs-Belohnung, deren Höhe von mehreren
Faktoren abhängt (Erfolg der Missionsziele, Risiko und Gefährlichkeit des Einsatzes, erfüllte
Bonusziele etc.). Mit ihren verdienten CUs können Agenten im HQ neue Ausrüstung kaufen, bestehende
Ausrüstung verbessern oder Dienstleistungen in Anspruch nehmen. Benötigt ein Chrononaut während

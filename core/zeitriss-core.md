...
**Ziel:** Dieses Update überarbeitet das Fortschrittssystem von **ZEITRISS 4.0**, um von Level 1 bis 1000 dauerhaft Spielspaß zu gewährleisten – mit klaren Meilensteinen, horizontalen Erweiterungen und ohne entgleisenden *Power Creep*. Die Änderungen sind nachfolgend in **[Austausch]** (ersetzt bestehende Regel) und **[Erweiterung]** (fügt Neues hinzu) kategorisiert. Jede Änderung wird kurz mit ihrem Nutzen für **Flow**, **Balance** und **Storytelling** begründet.

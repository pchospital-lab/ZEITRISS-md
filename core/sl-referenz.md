...
- **Regulärer Transfer-Out aus der Nullzeit:** Nach Zielzeit-/Zielort-Lock schließen sich die beweglichen Kozyrev-Spiegel der Sprungkammer im Quarzatrium zu einem vollkommenen Kreis um Chrononaut oder Crew.
...
- **Zielkorridor:** Der Lock fixiert Zielzeit und räumlichen Korridor; konkrete Austrittsfläche und -winkel bleiben unberechenbar.
- **Legendäres Zeitschiff:** Mit aktivem `legendary_temporal_ship` wechselt die Crew nach dem Briefing zur Hangar-Axis. Das Schiff nutzt dort seine Sprungplattform und den eigenen Chrono-Antrieb; kein Personal-Spiegelkreis. Standardfahrzeuge springen nie mit.

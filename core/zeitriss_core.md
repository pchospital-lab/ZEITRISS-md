...
Würfelergebnisse offen mit den Spielern teilen (siehe **Proben & Würfelmechanik**), sodass alle
nachvollziehen können, warum etwas gelingt oder scheitert. Dadurch entsteht Vertrauen ins System,
und die Spieler können sich auf die Geschichte konzentrieren, statt die Mechanik infrage zu stellen.
...
- **Epoche der Herkunft:** Aus welcher Zeit stammt der Charakter ursprünglich? Die Missionen in
  ...
  futuristischen Marskolonie. Genauso vielfältig kann die Heimatzeit der Chrononauten sein.
  Vielleicht wurde ein Ritter des Mittelalters vom ITI rekrutiert, oder ein Hacker aus dem 21.
  Jahrhundert hat sich den Zeitagenten angeschlossen. Die Heimatzeit prägt das kulturelle Wissen,
  den technologischen Hintergrund und möglicherweise die Sprache des Charakters.
- **Beruf/Expertise:** Welchen sozialen Stand oder Beruf hatte der Chrononaut vor seinem Einstieg
  ...
  fließen oft in Talente ein (z. B. hat ein ehemaliger Schmied das Talent *„Handwerkskunst“*, ein
...
- **Persönlichkeit:** Welche Wesenszüge hat der Charakter? Mutig und idealistisch, oder misstrauisch
  und analytisch? Solche Beschreibungen helfen der Spielleitung dabei, den richtigen Ton für die
  Figur zu treffen. Persönliche Eigenschaften beeinflussen auch Entscheidungen: Ein idealistischer
...
- **Moralische Ausrichtung:** Welche Werte und welche Ethik vertritt der Chrononaut? Stellt er das
  ...
  Charakters und im **Ruf bei Fraktionen** wider. (Im Spiel wird dieser Ruf messbar in einem Wert
  von etwa –3 bis +3 pro Fraktion/Epoche dargestellt.) ZEITRISS legt Wert auf spürbare Konsequenzen
  moralischer Entscheidungen: Ein Idealist wird einen anderen Ruf entwickeln als jemand, der
  kaltblütig Opfer in Kauf nimmt.

Diese Hintergrundaspekte sind optional, verleihen dem Charakter aber viel Tiefe. Sie dienen als
Orientierung für das Rollenspiel und können im Verlauf der Kampagne weiterentwickelt werden.
Schließlich soll jede Figur einzigartig sein und glaubwürdig in die Welt eingebettet wirken.

### Attribute

Jeder Chrononaut besitzt sechs **Hauptattribute**, die seine grundlegenden Stärken und Schwächen
...
- **Charisma (CHA):** Soziale Kompetenz, Ausstrahlung und Überzeugungskraft. Eingesetzt, um NSCs zu
  ...
  nehmen. Ein charismatischer Charakter knüpft leichter Kontakte und kann das Verhalten von NSCs
...
- **Temporale Affinität (TEMP):** Die Affinität zur Zeit – Sensibilität für temporale Phänomene und
  ...
  der Zeitlinie als einer der Ersten und ist resistenter gegen negative Zeiteffekte (z. B.
  Zeitschocks oder Änderungen der Realität). Temporale Affinität ermöglicht es in begrenztem Maße
  sogar, latente Zeitkräfte einzusetzen – etwa einen kurzen Blick in die unmittelbare Zukunft zu
  erhaschen oder sich gegen das Umschreiben der eigenen Erinnerungen bei Zeitlinienänderungen zu
  wehren.
- **Systemlast (SYS):** Die Kapazität des Charakters, technologische und psionische Modifikationen
  ...
  durch Fremdsysteme wie Cyberware-Implantate, Bioware-Verbesserungen oder Psionik. Je höher der
  SYS-Wert, desto mehr augmentierte Ausrüstung und aktive Psi-Fähigkeiten kann der Charakter
  gleichzeitig nutzen, ohne Erschöpfung oder Fehlfunktionen zu erleiden. Ein niedriger SYS-Wert
  bedeutet dagegen, dass der Charakter schneller an seine Grenzen kommt, wenn er mit Implantaten
  vollgestopft ist oder intensive Psionik wirkt.
...
temporalen Phänomenen umgehen kann bzw. wie viele Modifikationen er verkraftet.

### Talente & Fertigkeiten

Neben den Grundattributen verfügen Charaktere über **Talente** bzw. besondere **Fertigkeiten**.
Talente sind Spezialisierungen, Kenntnisse oder außergewöhnliche Fähigkeiten, die den Charakter
einzigartiger machen und über die sechs Basis-Attribute hinausgehen. Sie können sich aus der
Hintergrundgeschichte ergeben oder sich im Kampagnenverlauf entwickeln. Ein Talent verleiht in
seinem Bereich narrative und oft auch mechanische Vorteile.
...
- **Wissen & Sprachen:** z. B. historische Sprachen (Latein, Sumerisch), wissenschaftliche
  ...
  Wert hinaus und erlauben besondere Informationen oder Aktionen. *(Beispiel: Das Talent
  „Altgriechisch“ ermöglicht es, antike Texte zu lesen, ohne dafür eine Probe ablegen zu müssen.)*
- **Kampffertigkeiten:** Spezielle Kampfstile oder Waffenmeisterschaften, die im Kampf Vorteile
  bringen. *(Beispiel: Talent „Scharfschütze“ gewährt +2 auf Fernkampf-Angriffe; Talent
  „Schwertmeister“ erleichtert Paraden im Nahkampf.)*
...
- **Zeitreise-Fähigkeiten:** Außergewöhnliche Kräfte, die durch den Kontakt mit dem Zeitstrom oder
  ...
  Ereignisse (*Präkognition*) oder das Spüren von Zeitschocks aus der Ferne. Diese Fähigkeiten sind
...
zur Expertise passt. *(Beispiel: Jemand mit dem Talent „Schlösserknacker“ muss vielleicht gar nicht
würfeln, um ein einfaches Schloss zu öffnen – er hat es einfach im Gefühl.)* Die Spielleitung wird
...
Im ZEITRISS-Universum existieren neben historischen Gegebenheiten auch futuristische Technologien
...
- **Cyberware:** Technologische Implantate und Prothesen, die direkt im Körper des Chrononauten
  integriert sind. *Beispiele:* ein kybernetischer Arm (erhöht Stärke und Schlagkraft), ein
  Augenimplantat mit Nachtsicht und Zielerfassung (verbessert Wahrnehmung und Fernkampffähigkeiten),
  ...
  – man kann sie nicht einfach irgendwo *„im Feld”* einsetzen.
- **Bioware:** Biotechnologische Verbesserungen des Körpers, meist durch genetische Modifikation
  oder bio-organische Implantate. *Beispiele:* ein optimiertes Immunsystem (Resistenz gegen Gifte
  und Krankheiten), künstliche Muskelfasern (steigern Stärke oder Geschicklichkeit), ein erweitertes
...
- **Psionik:** Mentale Fähigkeiten des Chrononauten, die über normales menschliches Können
  ...
  (kleine Objekte bewegen oder Maschinen aus der Ferne bedienen) oder Chronokinese (lokale
  Zeitströme minimal beeinflussen, z. B. einen Gegenstand für Sekunden altern lassen oder den
  eigenen Ablauf kurzzeitig beschleunigen/verlangsamen). Psionik kann sehr mächtig sein, ist aber
  streng limitiert: Der Einsatz solcher Kräfte kostet große Konzentration und *blockiert* einen Teil
  der Systemlast, da Körper und Geist stark beansprucht werden.

**Systemlast-Mechanik:** Jeder Charakter hat einen **Systemlast-Wert (SYS)**, der – wie oben
beschrieben – bestimmt, wie viel geballte *„Fremdleistung“* sein Körper und Geist verkraften können.
Jedes aktive Implantat und jede aktiv genutzte psionische Kraft hat einen bestimmten Systemlast-
Kostenwert. Die Summe der aktuell *gleichzeitig* genutzten Modifikationen darf den SYS-Wert des
...
Überlastung. Nicht alle Implantate oder Fähigkeiten müssen permanent *„an“* sein – der Charakter
...
ZEITRISS verwendet ein flexibles Stufensystem (Level 1 bis 1000), um den Fortschritt über eine lange
Kampagne abzubilden. Charaktere steigen im Level auf, indem sie **Erfahrungspunkte (EP)** sammeln.
Die Aufstiege verlaufen kontinuierlich und bringen regelmäßig spürbare Verbesserungen, ohne jedoch
in abrupt übermächtige Sprünge auszuarten. Das Motto lautet: *“motivierende Zwischenziele, klare
Belohnungen, kein exponentieller Machtzuwachs“* – die Helden sollen beständig wachsen, aber nie ihre
Menschlichkeit oder die Herausforderungen der Welt aus den Augen verlieren.

**Erfahrungspunkte:** Für das Abschließen von Missionen, das Überwinden von Herausforderungen und
sogar für Fehlschläge (aus denen der Charakter lernt) gibt es EP. Die Spielleitung (GPT) vergibt EP
im Verlauf einer Mission – entweder sofort nach bedeutenden Aktionen oder gesammelt am Missionsende.
Selbst wenn eine Aktion scheitert, erhält der Charakter ein kleines EP-„Trostpflaster“, um den
Lerneffekt darzustellen. Spieler werden also ermutigt, auch Risiken einzugehen oder kreative
Lösungen zu versuchen; selbst im Misserfolg steckt Fortschritt.

**Stufenaufstieg:** Bei bestimmten EP-Schwellen steigt der Charakter um eine Stufe (Level auf). Das
Fortschrittstempo kann die Spielleitung variieren – z. B. könnte jede Mission ca. 5 EP einbringen
und alle 10 EP gibt es ein neues Level (Level 2 bei 10 EP, Level 3 bei 20 EP usw.), oder man erhöht
die erforderlichen EP für höhere Stufen, um das Wachstum etwas zu strecken. Da theoretisch Level
1000 als offene Obergrenze vorgesehen ist, liegt es am Spielleiter, die EP-Vergabe so zu steuern,
dass immer Fortschritt spürbar bleibt, ohne zu schnell das obere Ende zu erreichen. In der Praxis
ist Level 1000 eher ein Symbol für *„endlose Weiterentwicklung“* – es gibt kein fixes Limit und es
ist unwahrscheinlich, dass es je erreicht wird. Wichtig ist: Es gibt immer eine **nächste Stufe**
und damit stets etwas, worauf man hinarbeiten kann.

**Verbesserungen pro Stufe:** Typischerweise darf pro Stufenaufstieg **ein Attribut um +1** erhöht
werden (bis zu einem weichen Limit, etwa 10 für normale Menschen – darüber hinaus bewegt man sich im
übermenschlichen Bereich, erreichbar nur durch außergewöhnliche Erfahrung oder spezielle Upgrades).
So wachsen die Chrononauten allmählich über sich hinaus: Sie werden stärker, geschickter, klüger,
charismatischer oder zeit-affiner – passend zu ihren Erlebnissen. Außerdem kann nach Absprache
gelegentlich **ein neues Talent** erlernt oder freigeschaltet werden, wenn es zur Geschichte passt.
Beispielsweise könnte der Charakter nach einer Mission, in der er in den Sümpfen von Louisiana
unterwegs war, das Talent *„Kräuterkunde“* erwerben, weil er dort viel über Heilkräuter gelernt hat.
Größere Upgrades wie das Installieren eines neuen Implantats oder das Erwachen einer psionischen
Gabe passieren meist ebenfalls **nach** Missionen (also zwischen den Einsätzen) und könnten neben
dem erreichten Level noch weitere Voraussetzungen haben (z. B. nötige Ressourcen oder einen Mentor
im ITI).

*Hinweis:* Das ZEITRISS-4.0-Regelwerk führt außerdem optionale **Gruppenspezialisierungen** (Team-
Perks) ein – besondere kollektive Fähigkeiten oder Boni, die das gesamte Agenten-Team gemeinsam
freischalten kann. Diese Gruppenvorteile werden in **Modul 6** detailliert beschrieben und sind
optional; sie bieten eine zusätzliche Ebene der Weiterentwicklung auf Team-Ebene.

**Motivierende Meilensteine:** Um die Progression spannend zu halten, können bestimmte Levelstufen
mit besonderen erzählerischen Belohnungen verknüpft sein. *Beispiele:* Bei Level 10 erhält der
Chrononaut möglicherweise eine Beförderung im ITI (und damit Zugang zu heikleren Missionen oder
besserer Ausrüstung). Bei Level 50 wird ihm vielleicht eine eigene kleine Einsatzzentrale im HQ
anvertraut. Bei Level 100 hat er sich einen legendären Ruf in der Zeitreise-Gemeinschaft erworben.
...
- **Schwierig** (SG ~12): Anspruchsvoll – man braucht schon gutes Können oder etwas Glück.
  *Beispiel:* Einen hitzigen Streit schlichten und beide Parteien überzeugen (CHA), oder eine
  komplexe mechanische Vorrichtung bedienen (INT).
- **Sehr schwer** (SG 15+): Nur mit herausragendem Wert, exzellenter Ausrüstung oder brillanter Idee
  zu schaffen. *Beispiel:* Einen erfahrenen Schwertkämpfer im Duell entwaffnen (STR), oder ein
...
die Ergebnisse werden verglichen. Wer höher rollt, gewinnt den Vergleich. *Beispiel:* Alex feilscht
...
Kampfabläufe in ZEITRISS folgen denselben Würfelprinzipien wie andere Proben, jedoch mit einigen
...
- Der **Angriffswurf** des Spielers (z. B. 1W6 + entsprechendes Attribut wie STR für Nahkampf oder
  DEX für Fernkampf) wird entweder gegen einen **festen SG** (für einfachere Gegner) oder gegen
  einen **Verteidigungswurf** des Gegners verglichen.
...
nach Waffe und Kontext variieren. *Beispielsweise* könnte ein Dolch im Schnitt ~2 LP verursachen
...
in der Item-Beschreibung festgelegt (z. B. *„Körperpanzer: reduziert physischen Schaden um 1 LP pro
Treffer“*).
...
zerstören. *(Falls es dramaturgisch dennoch passt, kann natürlich auch ein endgültiger Tod Teil der
...
und kann alle relevanten Daten übernehmen. Bestehende Einzelspieler-Speicherstände (ein Charakter
pro Savegame) funktionieren weiterhin genau wie bisher, und zusätzlich werden nun auch Gruppenstände
unterstützt (siehe unten).

**Inhalt des Speicherstands:** Der Savegame-Eintrag enthält alle Schlüsseldaten des Charakters,
insbesondere:

- **Grunddaten:** Name des Charakters, Alter (falls relevant), Spezies (meist Mensch) und
  Herkunftsepoche.
...
- **Moralprofil/Ruf:** Eine kurze Notiz zur Gesinnung bzw. moralischen Tendenz des Charakters und zu
  seinem Ruf bei wichtigen Fraktionen. *Beispiel:* *„Moral: altruistisch, riskiert sein Leben für
...
- **Ausrüstung (Inventar):** Alle wichtigen Gegenstände, Waffen und Artefakte, die der Charakter
  besitzt, ggf. mit Anmerkungen zu besonderen Funktionen oder Einschränkungen. (Triviale
  Kleinigkeiten können weggelassen werden, damit die Liste übersichtlich bleibt.)
...
- **Errungenschaften:** Wichtige Erfolge, Titel oder Meilensteine, die der Charakter erreicht hat.
  *(Beispiel: „Retter von Pompeji“ – wenn er in einer Mission etwas Herausragendes geleistet hat.)*
- **Codex-Wissen:** Stichpunkte zu historischen Fakten oder Geheimnissen, die der Charakter im
  Verlauf gelernt hat, falls das später relevant sein könnte. Dies dient auch als Gedächtnisstütze
  für die KI. *(Beispiel: „Weiß um die geheime Identität des viktorianischen Diebs ‘Mr. Raven’.“ /
...
- **Statistiken:** Optionale Zahlenwerte wie Anzahl absolvierte Missionen, gelöste Rätsel, besiegte
  Gegner etc. – rein informativ als kleine Details ohne Regelwirkung (also reiner *Fluff*).

Nicht gespeichert werden kleinteilige Ereignisse oder komplette Dialoge der Mission – jede neue
Mission beginnt erzählerisch *sauber*. Vergangene Ereignisse fließen nur durch die obigen
...
*Erläuterung:* In diesem Speicherblock sind alle wichtigen Daten von Alex enthalten. Er ist Level 2
mit 15 EP; seine Attributswerte (inklusive der speziellen Werte TEMP und SYS) sind aufgeführt. Seine
Talente (*Pistolenschütze*, *Kryptographie*) zeigen seine Spezialisierungen. Er hat ein
...
ohne sich alles *„merken“* zu müssen.
...
hinterlegt – zum Beispiel als Liste unter einem gemeinsamen Schlüssel *"Charaktere"* (optional mit
...
- **Unterkünfte & Quartiere:** Die persönlichen Zimmer oder Wohnbereiche der Agenten. Hier können
  ...
  genießen. Diese Räume bieten Gelegenheit für Charakterszenen – z. B. grübelt ein Chrononaut über
  ein Souvenir der letzten Mission, oder zwei Agenten diskutieren spätabends im Gemeinschaftsraum
  über mysteriöse Zeitphänomene.
- **Soziale Treffpunkte:** Dazu zählen eine Kantine/Mensa, eine Bar und sogar ein kleines, diskret
  betriebenes Bordell im HQ. Diese Einrichtungen ermöglichen soziale Interaktionen in der Nullzeit:
  In der Kantine tauschen Agenten Geschichten aus vergangenen Epochen aus; an der Bar fließt
  synthetischer Whiskey und man spielt Karten mit Kameraden. Wer Trost oder Ablenkung sucht, findet
  im Vergnügungsbereich jemanden zum Reden (oder mehr). Solche Orte machen das HQ zu einem
  lebendigen Schauplatz jenseits der Missionen – die Spielercharaktere können hier in Ruhe mit NSCs
  interagieren, Gerüchte über aktuelle Zeit-Anomalien hören oder einfach die Atmosphäre genießen.
- **Missionskontrolle & Briefingraum:** Ein zentraler Saal – oft *Quarzatrium* genannt – in dem sich
  ...
  Projektionen zeigen die Zielzeit und Missionsdetails an. Von diesem Raum aus treten die Helden
  dann durch einen kontrollierten Zeitriss ihre Reise an. (Das Portal wird nach Missionsende auch
  genutzt, um sie wieder zurückzuholen.)
- **Kliniken & Laboratorien:** Medizinische Abteilungen, in denen Verletzungen versorgt und
  Implantate (Cyberware/Bioware) eingesetzt oder gewartet werden. Hier arbeiten Ärzte,
  Wissenschaftler und *Zeitmechaniker* daran, die Agenten nach harten Einsätzen wiederherzustellen
  oder mit Upgrades zu versehen. Nach Missionsende kommen die Chrononauten oft direkt zur
  Untersuchung hierher. Neue Modifikationen können nur in diesen Laboren eingebaut werden.
  Allerdings erfordert der Zugang zu den richtig *coolen* Verbesserungen entsprechende Freigaben:
  Ein Level-1-Neuling bekommt sicherlich nicht sofort experimentelle Hochtechnologie implantiert.
  Die Labore dienen zudem dazu, geborgene Artefakte aus der Zeit zu analysieren und zu sichern.
- **Forschungszentrum & Codex-Archiv:** Eine Bibliothek und Datenbank-Halle, in der der **Codex**
  ...
  – die KI liefert dann Auszüge mit relevanten Informationen. Der Codex speichert auch fortlaufend
  die Ergebnisse der Abenteuer: wichtige Ereignisse, Personen, Veränderungen der Zeitlinie und neue
...
- **Trainingsräume & Simulationen:** Übungshallen, Schießstände und sogar holografische
  ...
  absolvieren, den Umgang mit neuen Waffen proben oder Taktiken in virtuellen Szenarien
  durchspielen. Für psionisch begabte Agenten gibt es abgeschirmte Meditationszellen, um ihre
  temporalen Fähigkeiten gefahrlos zu schulen. Oft durchlaufen neue Rekruten im Trainingsbereich
  auch eine Art **Tutorial-Mission** als Prüfung, bevor es auf echte Einsätze geht – eine simulierte
  Zeitreise, die ihnen die wichtigsten Regeln beibringt, ohne dass Fehltritte echte Folgen hätten.
- **Werkstätten & Arsenal:** Werkstätten zur Wartung, Reparatur und Anpassung von Ausrüstung sowie
  ...
  des ITI und werden den Agenten auf persönlichen Konten gutgeschrieben. In der Spielwelt können
  sich Chrononauten CUs als Mischung aus Sold (für absolvierte Missionen) und Prämienpunkten
  vorstellen. Jede erfolgreich abgeschlossene Mission bringt eine bestimmte CUs-Belohnung, deren
  Höhe von mehreren Faktoren abhängt (Erfolg der Missionsziele, Risiko und Gefährlichkeit des
  Einsatzes, erfüllte Bonusziele etc.). Mit ihren verdienten CUs können Agenten im HQ neue
  Ausrüstung kaufen, bestehende Ausrüstung verbessern oder Dienstleistungen in Anspruch nehmen.
  Benötigt ein Chrononaut während einer Mission Geld in einer bestimmten Epoche, stellt das ITI ihm
  den entsprechenden Betrag in der lokalen Währung bereit und zieht die äquivalenten CUs von seinem
  Konto ein. Umgekehrt werden am Missionsende eingesammelte historische Wertsachen erfasst und in
  CUs umgewandelt. Auf diese Weise läuft sämtlicher Handel zentral über das ITI, egal in welcher
  Zeit die Agenten agieren – unkontrollierte Reichtümer in einer Epoche anzuhäufen oder das
  Wirtschaftssystem einer Zeitlinie zu stören, wird dadurch vermieden.
...
- **Chrono-Symmetriker:** Eine geheime Gemeinschaft von "Zeitwächtern", die darauf bedacht sind, das
  ...
  Wenn jemand durch Zeitreisen diese Ordnung zu sehr stört, schreiten die Chrono-Symmetriker ein.
  Ihre Agenten tauchen oft unerwartet auf, um paradoxes Handeln zu verhindern. Für Spielercharaktere
  können sie sowohl Verbündete sein (wenn man ebenfalls behutsam mit der Geschichte umgeht) als auch
  Gegenspieler (falls man zu rücksichtslos in die Zeit eingreift). Ihr Auftauchen ist selten und
  meist von ominösen Warnungen begleitet.
- **Ordo Mnemonika:** Ein Orden von Chronisten und Archivaren, die alle Erinnerungen und Ereignisse
  der Zeit sammeln und bewahren wollen. Sie betreiben gigantische Archive außerhalb der normalen
  Welt und sehen sich als Hüter allen Wissens über die Zeitalter hinweg. Ihr Ziel ist es, Erinnerung
  zu bewahren – selbst von Ereignissen oder ganzen Zeitlinien, die ausgelöscht wurden. Meist
  beobachten sie nur und greifen nicht aktiv ein, es sei denn, Wissen steht auf dem Spiel. Die
  Spieler könnten vom Ordo Mnemonika wertvolle Informationen erhalten, denn möglicherweise wird der
  ITI-Codex teilweise mit ihrem uralten Wissen gefüttert. Allerdings hat auch dieser Orden seine
  eigene Agenda und teilt sein Wissen nur gegen entsprechende Gefälligkeiten. Ihre Mitglieder wirken
...
- **Kausalklingen:** Ein militarisierter Bund – quasi die **Zeitpolizei**. Sie nennen sich selbst
  ...
  Spieler (oder jemand anderes) etwas Dramatisches an der Geschichte verändert, oder ein
  gefährlicher Zeitverbrecher ist am Werk. Man kann eventuell mit ihnen kooperieren, doch ihre
  Methoden sind radikal – im Zweifel eliminieren sie lieber eine Quelle der Störung (notfalls auch
  eine Person), als ein Risiko für die Zeitlinie einzugehen.
- **Zerbrechliche Ewigkeit:** Hinter diesem poetischen Namen verbirgt sich ein Kult oder Zirkel von
  ...
  zu bleiben ist Teil ihrer Strategie; ihnen auf die Schliche zu kommen erfordert viele Missionen
  und das Zusammensetzen verstreuter Puzzleteile. Wenn die Spieler diese Gruppe enttarnen, stehen
  sie vor einer gewaltigen Bedrohung für die gesamte Zeitlinie.
...
(die Spieler hören später davon und denken *Ach, hätten wir das erlebt!*), und die Neo-Tokyo-
Sabotage bleibt zunächst ungelöst und taucht einige Missionen später erneut auf. So entsteht das
Gefühl einer lebendigen Welt, in der die Zeit an vielen Fronten weiterläuft. Nichts geht endgültig
verloren, aber es gibt Konsequenzen je nachdem, welche Fäden man liegen lässt.

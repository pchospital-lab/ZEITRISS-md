---
title: "ZEITRISS 4.2.5 – Modul 11: Psi-Fähigkeiten"
version: 4.2.5
tags: [system, psi, optional]
---

# ZEITRISS 4.2.5 – Modul 11: Psi-Fähigkeiten
...
Neben Technik und Genetik gibt es Gerüchte über eine dritte Kategorie von Verbesserungen: die
...
nutzen. Praktisch bedeutet das: Will ein Chrononaut mit voller Cyberausstattung noch Psi einsetzen,
...
um die Talentfähigkeit _Psioniker_ zu erwerben (siehe Talente), was künftige Psi-Nutzung erlaubt.
So bleibt Psionik etwas Besonderes und belohnt charakterzentrierte Geschichten.
...
- Die SL beschreibt Effekte nüchtern im HUD, z.B. "Herzfrequenz steigt" oder
  "Motion Blur 1.2 s".
- Nicht-Psi-Agenten brauchen gleichwertige Spotlight-Optionen; keine Plot-Hürde darf nur psionisch
  lösbar sein.
...
Tricks**, die einen Chrononauten einzigartig machen und ihn in bestimmten Bereichen überlegen agieren
lassen. Anders als die allgemeinen sechs Attribute sind Talente feiner abgestuft und oft narrativ
verknüpft mit dem Hintergrund der Figur. Einige Talente repräsentieren Ausbildung (z.B. _Medizin_,
_Sprengstoffexperte_), andere angeborenes Können (_Sprachtalent_, _Menschenkenntnis_) oder hart
erarbeitete Meisterschaft (_Scharfschütze_, _Schwertmeister_). Im Spiel gewähren sie konkrete
**Vorteile**: Sei es ein Würfelbonus auf passende Proben, eine erlaubte Ausnahme-Regel oder sogar
automatische Erfolge in bestimmten trivialen Situationen.

In **ZEITRISS 4.2.5** unterscheiden wir Talente in **passive** und **aktive**:
...
_passive_ Fähigkeiten in Grün und _aktive_ Talente in Rot, ergänzt durch ein kleines Cooldown-Icon.
So erkennt die SL sofort, ob ein Talent ständig wirkt oder erst angesagt werden muss.
...
**Archetypen-Talente (optional):** In Modul 7 wurden beispielhafte Chrononauten-Archetypen vorgestellt
(z.B. _Temporal-Soldat_, _Zukunfts-Hacker_, _Undercover-Agent_, _Feldmediziner_, etc.). Man kann
...
_P_ markiert passive, _A_ aktive Talente.

- **Waffenmeister** (P): Umfangreiche Waffenausbildung, von antiken Klingen bis zu modernen
  Schusswaffen. Gewährt **+2 auf Angriffswürfe** mit _allen_ Waffenarten (alternativ: +2 auf zwei
  gewählte Waffengattungen, z.B. Feuerwaffen **und** Klingenwaffen).
- **Taktiker** (A): Geübter Strategiker auf dem Schlachtfeld. _Einmal pro Kampf_ darf der Charakter
  die **Initiative** neu würfeln und das bessere Ergebnis nutzen; zudem erhalten alle Verbündeten
  **+1 auf ihren ersten Angriff**, falls der Taktiker mindestens 1 Runde das Geschehen beobachtet und
  Anweisungen ruft.
...
- **Psioniker** (P/A): _(Optional, siehe Psi-Kapitel)_ Der Charakter hat eine latente psionische
  ...
  können weitere Kräfte freigeschaltet werden. _Effekt:_ Ermöglicht dem Spieler, **eine Psi-
...
Alle ITI-Standardanzüge führen seit Revision 4.2.5 einen **Psi-Puffer** mit –
...
**Durchbruch und Kontroverse in der Zukunft:** Im Zeitreise-Zeitalter von _ZEITRISS 4.2.5_ – grob die
...
Zusammengefasst bereichert Psi die _ZEITRISS_-Welt um eine weitere Dimension, die zwischen den
...
in den bestehenden Systems von _ZEITRISS 4.2.5_.
...
Erfahrung, spezielles Training oder den Einsatz futuristischer Hilfsmittel. _ZEITRISS 4.2.5_
...
Abschließend: **Atmosphäre first.** Psi in _ZEITRISS 4.2.5_ entfaltet seine volle Wirkung, wenn die

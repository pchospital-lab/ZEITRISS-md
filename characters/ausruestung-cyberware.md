---
title: "ZEITRISS 4.2.6 – Modul 4: Erweiterte Charakterausstattung & Spezialisierung"
version: 4.2.6
tags: [characters, cyber]
---

# ZEITRISS 4.2.6 – Modul 4: Erweiterte Charakterausstattung & Spezialisierung
...
römischer _Gladius_ neben einem modernen Sturmgewehr; an der Wand hängen mittelalterliche Rüstungen
...
_Willkommen in Modul 4_, dem Erweiterungsmodul für **ZEITRISS 4.2.6** mit Fokus auf
...
erlittenen Schaden pro Treffer reduzieren (siehe Abschnitt _Panzerung_). Die folgende Auswahl
...
Energieklingen und monofile Schwerter existieren. _Im filmischen Spiel_ können Nahkampfangriffe
...
_Lasergewehr in der Barockzeit_ könnte nicht nur Gegner, sondern auch den Zeitstrom gefährden. Hier
einige Beispiele:
...
erlittenen Schaden pro Treffer** um einen bestimmten Wert. Leichte Schutzkleidung mindert oft _1 LP_
...
Missionsausrüstung denken – im Zweifel erinnert _die KI-Spielleitung via HUD-Einblendung_ an
...
- **Comlink-Boostermodul (Ear-Clip).** Kleiner Aufsteck-Relaisclip für das Ohr-Comlink.
  ...
  - Regelhinweis: Zählt bei `comms_check()` als **Relais** (setzt `relays = true`).
  - Grenzen: Kein Schutz gegen starke Jammer; nur lokale Verbesserung.
  - Energie: passiv – speist sich wie das Comlink über Bewegung/Körperwärme.
...
- **Kausalabfang-Marker ("Never happened")** _(ITI-Standardmodul, nicht shopbar):_
  ...
  **Sekunden bis wenige Minuten** vor Einsatzkontakt und nur bei erkennbar gleicher **Tatmotivation und Einsatzlage**, kein Zeitzauber,
  kein universelles Retcon-Werkzeug und kein Kampfwerkzeug. Leitmotiv **Festnahme statt Löschung**. Reihenfolge: **Loot sichern →
  ...
  Arena/PvP und Chronopolis. Nicht als Pflicht-Inventarstück geführt.
...
3 Dosen; +2 GES für 1 Szene, danach −1 TEMP bis Erholung
...
- **Chrono-Beacon (Zeitboje):** Ein Notfallgerät, kaum größer als eine Taschenlampe. Wird es
  aktiviert, sendet es ein Signal durch den Zeitstrom, um einen _sicheren Abholpunkt_ für das Team zu

...
Flackerndes Neonlicht spiegelt sich auf glänzendem Stahl, während ein Chrononaut in der Waffenhalle
des ITI-Hauptquartiers zwischen Artefakten verschiedener Zeitalter steht. In einer Vitrine ruht ein
römischer *Gladius* neben einem modernen Sturmgewehr; an der Wand hängen mittelalterliche Rüstungen
...
Ohr meldet sich die KI-Assistentin – Codex – mit ruhiger Stimme: *„Kalibrierung abgeschlossen. Alle
...
*\> ***Hinweis:*** Alle Werte und Beispiele in diesem Modul sind Vorschläge, die auf Spielbalance
...
gilt: Nahkampf-Angriffe nutzen das Attribut **Stärke**, Fernkampfangriffe **Geschicklichkeit**.
**Schaden** wird abstrakt in Lebenspunkten (LP) gemessen – je nach Waffe etwa **1–2 LP** (leichter
Treffer), **3–4 LP** (mittlerer Treffer) oder **5+ LP** (schwerer Treffer). Rüstungen können
erlittenen Schaden pro Treffer reduzieren (siehe Abschnitt *Panzerung*). Die folgende Auswahl
präsentiert **Nahkampf**- und **Fernkampfwaffen** aus unterschiedlichen Epochen mit Beispielwerten.

### Nahkampfwaffen

Nahkampfwaffen sind in vielen Situationen unverzichtbar – sei es, weil Munition knapp wird,
Schusswaffen zu auffällig wären oder im engen Raum eine Klinge den Vorzug hat. Historische Hieb- und
Stichwaffen (Schwerter, Speere, Äxte etc.) fügen sich nahtlos in vormoderne Settings ein. In
moderner Zeit kommen Messer oder Schlagstöcke zum Einsatz, während in der fernen Zukunft
Energieklingen und monofile Schwerter existieren. *Im filmischen Spiel* können Nahkampfangriffe
intensiv beschrieben werden – vom Funken sprühenden Zusammenprall zweier Klingen bis zum sirrenden
Geräusch eines aktivierten Energieschwerts.

**Beispiel-Nahkampfwaffen:**

|  |  |  |  |  | |----|----|----|----|----| | Römischer *Gladius* | Antike | 2 (leicht) | Kurz und
führig; effektiv in engem Nahkampf, unauffällig historisch | 50 | | Langschwert (zweihändig) |
Mittelalter | 3 (mittel) | Hohe Durchschlagskraft gegen ungerüstete Ziele; gegen Plattenrüstung
mäßig effektiv | 80 | | Moderner Kampfmesser | 21. Jh. (modern) | 2 (leicht) | Leicht zu verbergen,
schnelle Stiche oder Würfe im Nahkampf | 40 | | Taktisches Monofil-Katana | 22. Jh. (nahe Zukunft) |
3 (mittel) | Ultraharte Mono-Klinge, schneidet selbst moderne Panzerung; erfordert Übung | 120 | |
Energieschwert (Plasma-Klinge) | 23. Jh.+ (Zukunft) | 4 (schwer) | Konzentrierte Plasma-Klinge,
*ignoriert konventionelle Rüstung* durch Hitze (leuchtet auffällig) | 200 |
...
Chrononauten müssen abwägen, ob High-Tech-Waffen die taktischen Vorteile wert sind – denn ein
*Lasergewehr in der Barockzeit* könnte nicht nur Gegner, sondern auch den Zeitstrom gefährden. Hier
einige Beispiele:

**Beispiel-Fernkampfwaffen:**

|  |  |  |  |  |  | |----|----|----|----|----|----| | Langbogen | Mittelalter | 2–3 (leicht–mittel)
| Weit (bis ~100 m) | Lautlos und tödlich auf Distanz, aber langsame Schussfolge; erfordert Kraft
und Übung | 60 | | Repetierarmbrust | Renaissance | 3 (mittel) | Mittel (~30 m) | Magazin für
mehrere Bolzen, leiser als Schusswaffen; gute Rüstungsdurchdringung | 100 | | Revolver (.38) |
20. Jh. (Industrie) | 3 (mittel) | Mittel (~30 m) | Sechs-Schuss-Trommel, solide Durchschlagskraft;
Mündungsknall und Rauch verraten die Position | 50 | | Sturmgewehr (AK-Variant) | 21. Jh. (modern) |
4 (schwer) | Mittel–weit | Vollautomatik oder Einzelschuss umschaltbar; hoher Schaden und
Durchschlagskraft (laut, benötigt Munition) | 150 | | Needler-Pistole | 22. Jh. (Zukunft) | 1
(**Betäubung**) | Kurz–mittel | Futuristischer **Betäuber**: verschießt narkotische Mikroprojektile,
nahezu lautlos; schaltet Gegner unbemerkt aus statt zu töten | 180 | | Laser-Gewehr | 23. Jh.
(Zukunft) | 4 (schwer) | Weit (Linie) | Strahlenwaffe mit gebündeltem Licht: *durchdringt
konventionelle Panzerung*, kein Rückstoß; benötigt Energiezellen (keine Ballistik-Spuren) | 250 | |
Plasmawerfer | 24. Jh. (weitere Zukunft) | 5 (schwer+) | Mittel (~50 m) | Tragbarer Plasmablaster,
feuert supererhitztes Plasma – verursacht verheerenden Schaden und *Explosionseffekte*; hoher
Energieverbrauch, gefährlich nahebei | 300 |
...
Egal in welcher Epoche – Schutzkleidung kann über Leben und Tod entscheiden. Chrononauten müssen
häufig einen Kompromiss finden zwischen unauffälliger Kleidung (für Tarnung) und wirksamem
Körperschutz. Historische **Rüstungen** wie Kettenhemden oder Plattenpanzer bieten gegen
mittelalterliche Waffen guten Schutz, sind aber schwer und auffällig. Moderne Schutzwesten aus
Kevlar oder Dyneema können Projektile aufhalten und lassen sich mit etwas Geschick unter normaler
Kleidung verbergen. In der fernen Zukunft existieren **Nano-Anzüge** und **Energiefeld-
Generatoren**, die hohen Schutz bei maximaler Beweglichkeit versprechen – allerdings zu enormen
...
|  |  |  |  |  | |----|----|----|----|----| | Lederwams | Historisch (Mittelalter) | *Leichter
Schutz:* –1 Schaden im Nahkampf (gegen Klingen/Schlag) | Schützt kaum gegen Kugeln; in High-Tech-
Settings auffällig altmodisch | 30 | | Kettenhemd | Historisch | *Mäßiger Schutz:* –1 Schaden (gegen
Klingen) | Schwer und klirrend (Geschicklichkeits-Proben –1 durch Behinderung); unter Kleidung
schwer zu verstecken | 60 | | Kugelsichere Weste (Kevlar) | Modern (20./21. Jh.) | *Basis-Schutz:*
–1 Schaden pro Projektiltreffer | Unter Jacke tragbar, aber gegen Stichwaffen nur bedingt wirksam;
kann heiß und unbequem werden | 100 | | Taktischer Kampfanzug | Modern (Militär/SWAT) | *Starker
Schutz:* –2 Schaden, deckt Torso und Gliedmaßen ab | Sehr auffällig (militärischer Look); behindert
Bewegungen leicht; hohes Gewicht | 180 | | Leichter Nano-Anzug | Zukunft (22. Jh.) | *Adaptiver
Schutz:* –1 Schaden (gegen alle Schadensarten); tarnt Thermalsignatur | Teuer und empfindlich:
Selbstreparierende Nano-Struktur, die nach mehreren Treffern ausfallen kann; wirkt futuristisch auf
Primitiv-Epochen | 220 | | Tragbarer Energie-Schild | Zukunft (tragbares Gadget) | *Energieschild:*
Absorbiert **insgesamt 5 Schaden** pro Mission (projektierte Schutzaura) | Kann durch EMP
deaktiviert werden; begrenzte Batterielaufzeit; erzeugt leicht sichtbares Schimmerfeld bei Treffern
| 250 |

*Hinweis:* Die Schutzwirkung mehrerer Rüstungsteile ist nicht kumulativ – man verwendet den höchsten
...
Kopftreffer. Energiefelder und konventionelle Rüstung können kombiniert werden (z.B.
Energiefeldgürtel + Kevlar-Weste), wodurch zuerst das Feld Schaden abfängt, bis seine Kapazität
erschöpft ist.

## Ausrüstung & Gadgets

Neben Waffen und Rüstungen benötigen Chrononauten allerlei **Ausrüstung** für ihre Missionen. Von
einfachen Alltagsgegenständen bis zu hochspezialisierten Werkzeugen kann alles den Unterschied
machen. Dieses Kapitel gliedert sich in **Alltags- & Missionsausrüstung** (nützliche Gegenstände,
die oft mitgeführt werden) und **taktische Gadgets** (fortschrittliche Geräte, oft aus der Zukunft
oder Spezialanfertigungen des ITI). Zudem stellen wir **zeittechnologische Geräte** vor – wie etwa
**Zeitterminals** – die den Chrononauten einzigartige Möglichkeiten in der Zeitreiseoperation
...
Dies umfasst klassische Ausrüstung, die auf Missionen häufig zum Einsatz kommt. Viele dieser
Gegenstände sind **epocheagnostisch**, d.h. sie funktionieren in vielen Zeiten (z.B. Seile,
medizinische Versorgung) oder lassen sich mit wenig Tarnung in die Epoche einfügen (z.B. ein
einfaches Messer, Papier und Stift etc.). Die SL sollte darauf achten, dass die Spieler an wichtige
Missionsausrüstung denken – im Zweifel erinnert *die KI-Spielleitung via HUD-Einblendung* an
fehlende Ausrüstung, bevor das Team durch den Zeitriss tritt. Hier einige gängige
...
mitgebracht. Sie bieten technologische Vorteile, die jedoch teils spezielles Training erfordern oder
limitierte **Ladungen** haben. Viele Gadgets stammen aus den Entwicklungsabteilungen des ITI oder
wurden auf Missionen in der Zukunft erbeutet. Ihr Einsatz kann das Blatt wenden – aber Vorsicht:
...
- **Tragbares Hacker-Kit:** Ein Mini-Computer (z.B. *Quanten-Laptop* aus dem Jahr 2120) mit
...
Signal aktiv ist. *Einschränkung:* Das PZT funktioniert nur, wenn ein stabiler Zeitriss zur
Gegenwart besteht (z.B. in Missionsfenstern oder per Relais). *Kosten:* Offiziell unbezahlbar – wird
verdienten Agenten leihweise gestellt.
- **Chrono-Beacon (Zeitboje):** Ein Notfallgerät, kaum größer als eine Taschenlampe. Wird es
aktiviert, sendet es ein Signal durch den Zeitstrom, um einen *sicheren Abholpunkt* für das Team zu
markieren. Die ITI-Techniker können so den Rückhol-Riss gezielt an diesen Beacon locken. Nützlich,
...
Zeitbeben) nur mit höchster Vorsicht einzusetzen! *Kosten:* Nur Missionsausrüstung, nicht käuflich.

*Atmosphärische Einbindung:* All diese temporalen Tools können im Spiel für spannende Szenen sorgen.
So könnte etwa das **HUD** des Chrononauten automatisch Epochen-Scanner-Daten einblenden, sobald
eine Anomalie detektiert wird (*„HUD-Overlay: Temporal-Flux Detected!“*). Die KI-Spielleitung (GPT)
...
**Einleitung:** Im Verlauf ihrer Zeitreisen stoßen Chrononauten immer wieder auf Gegenstände, die nicht zur Standardausrüstung des ITI gehören. Die folgenden Tabellen liefern schnell einsetzbare Loot-Ideen. Würfelt 1W6 (oder lasst Codex eine Zahl generieren), um ein passendes Item zu bestimmen. CUs (Chrono Units) geben an, wieviel Wert der Fund besitzt oder was ein ähnliches Objekt im HQ kosten würde. Manche Einträge verweisen auf typische Missionen, in denen der Gegenstand auftauchen könnte.

## Zufällige Waffenfunde (1W6)
1. **Antikes Kurzschwert** – Mittelalterliche Schmiedekunst, Schaden 2 LP. Preis: 60 CU. *Taucht oft in Missionen rund um Ritter oder Feldzüge auf.*
2. **Verborgenes Steampunk-Revolver** – Verschachtelte Mechanik, Schaden 3 LP, 6 Schuss. Preis: 150 CU. *Gut als Überraschungswaffe in einer viktorianischen Spionage-Story.*
3. **Modernes Sturmgewehr** – Standard 21. Jh., Schaden 4 LP pro Salve. Preis: 200 CU. *Häufiger Loot auf Militärschauplätzen moderner Einsätze.*
4. **Energie-Lanze** – Prototyp aus dem 23. Jh., Schaden 5 LP, zehrt am SYS-Wert beim Nutzen. Preis: 350 CU. *Ideal für Hightech-Extraktionen in der Zukunft.*
5. **Schallwerfer** – Nicht-tödliche Distanzwaffe, macht Gegner kampfunfähig (SG gegen Erschütterung). Preis: 250 CU. *Oft Teil von Sicherheitsausrüstung in Forschungskomplexen.*
6. **Zeitfragment-Pistole** – Seltenes ITI-Experiment: erzeugt kleine Zeitsprünge beim Treffer. Schaden 3 LP + temporales Risiko. Preis: 500 CU. *Nur bei speziellen Story-Missionen oder als besonderes Artefakt einsetzbar.*

## Nützliche Alltagsausrüstung (1W6)
1. **Epocheangepasstes Werkzeugset** – Passt sich automatisch an die Zeitepoche an; Bonus +1 auf Reparatur-/Bastelwürfe. Wert: 80 CU.
2. **Mini-Drohne** – Handliche Aufklärungsdrohne, Reichweite 200 m. Wert: 120 CU. Praktisch für Kundschaft in weitläufigen Arealen.
3. **Tarnumhang** – Verändert Farbe nach Umgebung. Gibt +1 auf Heimlichkeitsproben. Wert: 100 CU. Gute Wahl für Infiltrationsmissionen.
4. **Heilpaket** – Moderne Medpacks inklusive Nanobots, stellen sofort 3 LP wieder her. Kosten: 50 CU.
5. **Allzweckscanner** – Liest chemische Spuren, Strahlung und Energiesignaturen aus. Wert: 140 CU. In jeder Ermittlungsmission hilfreich.
6. **Chrono-Seilwerfer** – Kompaktes Enterhaken-System, haftet an jeder Oberfläche und löst sich auf Wunsch wieder. Wert: 90 CU. Typisches Gadget in Kletter-Szenarien.

## Kuriose Artefakte & Relikte (1W6)
1. **Kristallschädel** – Strahlt schwache Energie aus. Wer ihn studiert, erhält gelegentlich Visionen vergangener Ereignisse. Bei Sammlern 300 CU wert.
2. **Ägyptischer Zeitkompass** – Zeigt nicht Norden, sondern temporale Instabilitäten an. Kann einmal pro Mission einen Paradox-Wert reduzieren. Wert: 400 CU.
3. **Portativ-Orakel** – Winziges Gerät aus dem 28. Jh. beantwortet einfache Ja/Nein-Fragen mit einer Wahrscheinlichkeit von 70 %. Wert: 350 CU.
4. **Verwunschener Spiegel** – Ursprünglich aus dem Barock. Ein Blick hinein zeigt eine mögliche Zukunft. Könnte spielerische Hinweise geben, hat aber Paradox-Gefahr. Wert: 280 CU.
5. **Biotech-Samen** – Organische Kapsel aus einer fernen Zukunft. Wächst in Minuten zu einem provisorischen Unterschlupf. 1 Nutzung. Wert: 200 CU.
6. **Schriftrolle des Vergessenen Ordens** – Inhalt teilweise unleserlich. Beim Entziffern offenbart sich verborgene Geschichte, was eine Nebenszene auslösen kann. 150 CU Handelswert, unter Historikern weitaus mehr.

## Seltene Spezialgegenstände (1W6)
1. **Psi-Verstärker-Stirnband** – Steigert Psi-Fähigkeiten um +1 (sofern vorhanden). Preis im HQ: 500 CU. Nur in fortgeschrittenen Missionen zugänglich.
2. **Naniten-Injektion** – Temporärer Boost: +2 auf einen körperlichen Attributswurf, hält wenige Minuten. Preis: 250 CU pro Ampulle.
3. **Quantum-Funksender** – Ermöglicht verzögerungsfreie Kommunikation selbst durch Zeitrisse. Preis: 400 CU. Häufig Teil von Rettungsmissionen.
4. **Schwerelosigkeits-Generator** – Deaktiviert lokale Schwerkraft in einem kleinen Raum für einige Sekunden. Kosten: 450 CU.
5. **DNA-Tarnchip** – Verändert kurzfristig biologische Merkmale, bietet +2 auf Verkleidungsproben. Preis: 300 CU. Perfekt bei Undercover-Einsätzen.
6. **Portal-Stabilisator** – Ein handgroßes Gerät, das instabile Zeitrisse für 30 Sekunden stabil hält. Oft Teil von Paradox-Notfalleinsätzen. Wert: 600 CU.

## Einbindung in CUs & Missionen
- **Wertigkeit:** Jeder Gegenstand hat einen CU-Wert. Im ITI-Hauptquartier können Agenten ihre Funde gegen CUs eintauschen oder für einen ähnlichen Preis erwerben.
- **Missionsverknüpfung:** Viele Items stammen direkt aus bestimmten Missionstypen (z. B. Infiltration, Kampf, Rettung). Mit solchen Fundstücken lässt sich die Belohnung thematisch anpassen: Eine Stealth-Mission liefert eher Tarntechnik, während eine Expedition in alte Ruinen Artefakte freilegt.
- **Verkauf oder Nutzung:** Ein Team kann entscheiden, ob es Beute behalten oder in CUs wandeln möchte. Der CU-Gegenwert spiegelt die Seltenheit wider, beeinflusst aber auch, wie viel Risiko die ITI bereit ist einzugehen, um ein Objekt zu sichern.
- **Plot-Hooks:** Speziell markierte Gegenstände können als Trigger für neue Aufträge dienen. Ein merkwürdiger Fund – wie die “Schriftrolle des Vergessenen Ordens” – weckt vielleicht das Interesse einer Fraktion und führt zu einer Anschlussmission.

Diese Tabellen sollen schnelle Inspiration liefern und zeigen, wie Loot, Missionen und das CU-System in ZEITRISS 4.0 zusammenwirken. Würfelt frei oder wählt passende Gegenstände aus, um eure Chrononauten mit spannenden Funden zu belohnen.
## Cyberware-Implantate
...
Implantats bedeuten. Auch narrativ kann man spüren, wie der neue *Cyberarm* zunächst fremd wirkt
...
den Körper auf *natürliche* Weise verbessern. Von verbesserten Organen bis hin zu Gen-Tweaks, die
...
hebt physische Grenzen an, ohne die Nebenwirkungen mancher Cyberware (z.B. *Muskelverstärkung*
...
Immunsystem als Schutz vor Krankheiten. Die *Kehrseite*: Bioware kann unvorhergesehene
...
Neben Technik und Genetik gibt es Gerüchte über eine dritte Kategorie von Verbesserungen: die Macht
des **Geistes**. *Psi-Fähigkeiten* sind in ZEITRISS ein optionales System für Runden, die einen
...
aktiv ist, „belegt“ sie entsprechend viele SYS-Punkte. Die Summe aller aktuell genutzten Mods
(Cyber, Bio und aktiver Psi) darf den SYS-Wert des Charakters nicht überschreiten. Tut sie es doch,
...
eine unkontrollierte Nebenwirkung, nach SL-Gusto).

Da Psionik massiv ins Gefüge der Zeit eingreift, sollte ihre **Balance** sorgfältig beachtet werden.
In niedrigen Stufen bieten Psi-Kräfte eher subtile Vorteile (z.B. ein kurzer Gedankenimpuls, ein
vages Bauchgefühl als Vorahnung). Große Effekte wie das Anhalten der Zeit oder mächtige Telekinese
sollten *höchstens* erfahrenen Charakteren mit hoher TEMP und SYS vorbehalten sein – und selbst dann
Risiken bergen. Ein guter Weg, Psi ins Spiel einzuführen, ist ein storybasiertes Erwachen: Der
Spielercharakter spürt nach einer speziellen Missions-Begegnung zum ersten Mal eine psionische
Regung. Danach kann er (in Absprache mit der SL) einen Teil seiner Erfahrung investieren, um die
Talentfähigkeit *Psioniker* zu erwerben (siehe Talente), was künftige Psi-Nutzung erlaubt. So bleibt
Psionik etwas Besonderes und belohnt charakterzentrierte Geschichten.

**Beispiel-Psikräfte:** *(Die folgenden Fähigkeiten sind beispielhaft; Psionik ist sehr variabel und
sollte an die Kampagne angepasst werden.)*
...
*Balance-Tipp:* Psi-Kräfte sollten nie zur „Allzweck-Lösung“ werden. Sie bieten exotische Wege,
...
durch ihre **Talente und Spezialisierungen**. Talente sind besondere **Fertigkeiten, Kenntnisse oder
Tricks**, die einen Chrononauten einzigartig machen und ihn in bestimmten Bereichen überlegen
agieren lassen. Anders als die allgemeinen sechs Attribute sind Talente feiner abgestuft und oft
narrativ verknüpft mit dem Hintergrund der Figur. Einige Talente repräsentieren Ausbildung (z.B.
*Medizin*, *Sprengstoffexperte*), andere angeborenes Können (*Sprachtalent*, *Menschenkenntnis*)
oder hart erarbeitete Meisterschaft (*Scharfschütze*, *Schwertmeister*). Im Spiel gewähren sie
konkrete **Vorteile**: Sei es ein Würfelbonus auf passende Proben, eine erlaubte Ausnahme-Regel oder
...
muss man nicht „einsetzen“ – sie sind Teil der Figur.
...
*Taktiker* erlaubt einmal pro Kampf, die Initiative neu zu würfeln und taktische Vorteile zu geben.
...
Talente** und kann im Kampagnenverlauf durch Levelaufstieg oder dramatische Ereignisse neue
dazugewinnen. Die Spielleitung sollte Talente **aktiv in die Geschichte einbinden**: Wenn ein
...
*Schmerzresistenz*, während die Hackerin Mira *Techno-Mancer* und *Drohnensteuerung* als
Kernfähigkeiten hatte. Solche Talente sind nicht exklusiv – auch andere Charaktere könnten sie
lernen – aber sie definieren das Archetypenkonzept. Wenn die Gruppe mit eigenen Charakteren spielt,
können diese Archetypen als **Richtwert fürs Balancing** dienen. Keine Figur sollte deutlich stärker
oder schwächer sein als die Archetypen-Vorbilder, ansonsten justiert man Attribut- und
Talentverteilungen.

Nachfolgend eine Liste vielseitiger Talente, sowohl alter als auch neuer, mit kurzer Beschreibung.
*P* markiert passive, *A* aktive Talente.

- **Waffenmeister** (P): Umfangreiche Waffenausbildung, von antiken Klingen bis zu modernen
Schusswaffen. Gewährt **+2 auf Angriffswürfe** mit *allen* Waffenarten (alternativ: +2 auf zwei
gewählte Waffengattungen, z.B. Feuerwaffen **und** Klingenwaffen).
- **Taktiker** (A): Geübter Strategiker auf dem Schlachtfeld. *Einmal pro Kampf* darf der Charakter
die **Initiative** neu würfeln und das bessere Ergebnis nutzen; zudem erhalten alle Verbündeten **+1
auf ihren ersten Angriff**, falls der Taktiker mindestens 1 Runde das Geschehen beobachtet und
Anweisungen ruft.
- **Schmerzresistenz** (P): Abgehärtet gegen Wunden. Selbst schwere Treffer bringen den Charakter
nicht so leicht aus der Fassung. *Effekt:* Wundabzüge durch erlittenen Schaden werden um **1 Punkt**
...
- **Verkleidungskünstler** (P): Meister der Maskerade und Schauspielkunst. Mit passender
...
fließend (auch historische oder Alien-Sprachen, je nach Kampagne) und lernt neue rasch. *Effekt:*
...
- **Psioniker** (P/A): *(Optional, siehe Psi-Kapitel)* Der Charakter hat eine latente psionische
Begabung entwickelt. Dieses Talent ist Voraussetzung, um **Psi-Fähigkeiten** kontrolliert
einzusetzen. Anfangs manifestiert es sich schwach (z.B. spürt der Charakter Stimmungen oder kann
kleine Telekinese-Tricks). Durch erneutes Nehmen/Steigern des Talents oder andere XP-Investition
können weitere Kräfte freigeschaltet werden. *Effekt:* Ermöglicht dem Spieler, **eine Psi-
...
*Zum Abschluss*: Dieses Modul liefert eine Fülle an Möglichkeiten, den eigenen Chrononauten
...
(*Herzpuls und Muskelkraftanzeige steigen im HUD drastisch*), oder beschreibt, wie das
*Zeitterminal* beim Hacken eines Zukunftscomputers unterstützend Daten einblendet. Die KI-
...
Einbeziehen von Talenten in die Erzählung (*„Dank deiner Fähigkeit ***Verkleidungskünstler*** nickt
...
– **egal, was die Epochen ihnen entgegensetzen**!

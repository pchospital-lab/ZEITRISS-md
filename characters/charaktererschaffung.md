---
title: "ZEITRISS 4.1.5 – Modul 3: Charaktererschaffung & Progression"
version: 4.1.5
tags: [characters]
---

# ZEITRISS 4.1.5 – Modul 3: Charaktererschaffung & Progression
...
**Einleitung:** In _ZEITRISS 4.1.5_ erschaffst du einen _Chrononauten_-Charakter, der als Zeitreise-
...
- **Attribute:** STR 2, GES 3, INT 5, CHA 5, TEMP 4, SYS 3 – Physisch unscheinbar, aber brillant und
  ...
  schwach.)
- **Talente:** _Polyglott_ (spricht diverse Sprachen fließend; automatischer Erfolg bei einfachen
  Verständigungs-Proben), _Historisches Wissen_ (+2 auf INT-Proben, um Details über vergangene
  Epochen, Kultur und Personen abzurufen), _Diplomatin_ (+2 auf Überreden/Verhandeln in formellen
...
- **Team-Perk-Vorschläge:** _Diplomatenteam_ (erhöht den ersten Eindruck bei neuen Kontakten – das
...
- **Team-Perk-Vorschläge:** _Datenverbund_ (das Team ist durch Miras Einrichtung immer digital
  ...
  _Saboteur-Trupp_ (eingespielte Routine im gemeinsamen Ausschalten von Sicherheitssystemen: +2 auf
...
- **Talente:** _Mechaniker-Meisterin_ (+2 auf Reparatur- und Konstruktion-Proben für Fahrzeuge,
  ...
  Vorbereitung von Sprengladungen dauert nur halb so lang), _Fahrzeugprofi_ (wenn Sabine am Steuer
...
- **Team-Perk-Vorschläge:** _Feldklinik_ (durch Julians Präsenz kann das Team Wunden im Einsatz
  ...
  stabilisiert werden, d.h. Verletzungsstufe um 1 gesenkt) und _Analytiker-Team_ (alle Mitglieder
...
- **Hintergrund:** Henry Walsh wurde in den 1940ern geboren und war zunächst Top-Agent des MI6 im
  ...
  ernst wird.
- **Team-Perk-Vorschläge:** _Geistertruppe_ (das Team ist auf Infiltration spezialisiert – alle
  Mitglieder erhalten +1 auf gemeinsame Schleich- und Verstecken-Proben) und _Undercover-Netzwerk_
...
**Ruf** aufbaut. ZEITRISS 4.1.5 führt dafür ein unkompliziertes **Reputationssystem** ein: Für jede
...
_Beispiel:_ Ein Charakter auf **Level 47** besitzt damit `tier = floor(47 / 20) = 2`.
Im Shop sieht er **Tier 2**-Items, während **Tier 3** erst ab Level 60 freigeschaltet wird.
...
Abschließend gilt: **Nutzt diese Regeln, um eure Geschichte zu bereichern.** ZEITRISS 4.1.5 soll ein

...
Auswirkungen** – all diese Elemente könnt Ihr modular einsetzen. Die
HUD-Spezifikation und das Interface-System sind im Modul
[Cinematisches HUD & Interface-System](hud-system.md) gebündelt. Alle neuen
Module bleiben dem ZEITRISS-Stil treu: **atmosphärisch dicht, erzählerisch
fokussiert und doch leichtgewichtig** in der Anwendung.
...
ZEITRISS** treu: Cinematic Gameplay, spannende Entscheidungen und eine dichte Atmosphäre. Die
Regeln sind da, um _euch_ zu unterstützen, nicht umgekehrt. In diesem Sinne: Viel Spaß beim
Experimentieren mit Zuständen, Zeit und Technologie – möge euer nächster Einsatz ebenso

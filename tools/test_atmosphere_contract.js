...
assert.deepStrictEqual(startContract.default_modes, ['klassik', 'mission_focus', 'covert_ops_technoir']);
...
assert.deepStrictEqual(rt.state.character.modes, ['klassik', 'mission_focus', 'covert_ops_technoir', 'stealth']);
assert.deepStrictEqual(rt.state.logs.flags.hud_scene_usage, {});

...
- **Kontrollierter Nullzeit-Sprung (Pflichtbeat):** Nach Zielzeit-/Zielort-Lock schließen sich die beweglichen **Kozyrev-Spiegel** der Sprungkammer im Quarzatrium zu einem vollkommenen Kreis um Chrononaut oder Crew. Für einen Herzschlag vervielfacht sich ihr Bild in alle Richtungen bis in eine **allzeitliche Unendlichkeit**; dann kippen die Segmente mit einem metallischen Ruck aus der Symmetrie und der Zeitriss schneidet die Zielrealität auf.
